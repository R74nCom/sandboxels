...
chemjsChemicals.boron = {
  elem: { color: ["#80736a", "#a2999c", "#5e5544", "#292d2c"], category: "solids", density: 2080, state: "solid", behavior: behaviors.WALL, fireColor: ["#34eb67", "#5ceb34"], },
  tempHigh: [2076],
};
...
chemjsChemicals.fluorine = {
  elem: { color: "#FFFFBF", behavior: behaviors.GAS, tick: (pixel) => fluorineTick(pixel, 1), state: "gas", category: "gases", density: 1.7, stain: 0.005 },
  tempLow: [-188.1, -219.7],
  densityLow: [1505],
  causticIgnore: true,
...
elements.liquid_fluorine = { color: "#ffff3b", behavior: behaviors.LIQUID, tick: (pixel) => fluorineTick(pixel, 0.01), temp: -198.1, state: "liquid", category: "liquids", stain: 0.005, hidden: false };
...
chemjsChemicals.white_phosphorus = {
  elem: { color: "#f4f7ad", category: "powders", density: 1820, state: "solid", behavior: ["XX|XX|XX", "XX|XX|XX", "M2%1|M1|M2%1",], tick: whitePhosphorusTick, stain: 0.01, burn: 1, burnTime: 300, burnInto: "phosphorus_pentoxide", fireColor: "#5ed6c8", },
  tempHigh: [44.1, 280],
  stateHigh: [null, "white_phosphorus_gas"],
};

elements.molten_white_phosphorus = { color: "#eaeb96", tick: whitePhosphorusTick, state: "liquid", behavior: behaviors.LIQUID, density: 1810, stain: 0.01, burn: 1, burnTime: 300, burnInto: "phosphorus_pentoxide", fireColor: "#5ed6c8", };

elements.white_phosphorus_gas = { tick: whitePhosphorusTick, behavior: behaviors.GAS, density: 5.13, stain: 0.01, burn: 1, burnTime: 300, burnInto: "phosphorus_pentoxide", fireColor: "#5ed6c8",  };
...
chemjsChemicals.red_phosphorus = {
  elem: { tick: redPhosphorusTick, color: ["#fa5252", "#de4040", "#f24141"], category: "powders", density: 2275, state: "solid", behavior: behaviors.POWDER, stain: 0.005, fireColor: "#5ed6c8", },
  tempHigh: [530],
  stateHigh: [["violet_phosphorus"]],
};

chemjsChemicals.violet_phosphorus = {
  elem: { color: ["#d92378","#ab1364","#bd1c8a"], category: "powders", density: 2360, state: "solid", behavior: behaviors.STURDYPOWDER, stain: 0.005, fireColor: "#5ed6c8", burn: 0.1, burnTime: 300, burnInto: "phosphorus_pentoxide", },
  tempHigh: [860],
...
chemjsChemicals.black_phosphorus = {
  elem: { color: ["#170a02","#380e03","#6b6968"], category: "powders", density: 2690, state: "solid", behavior: behaviors.SUPPORTPOWDER, stain: 0.005, fireColor: "#5ed6c8", },
  tempHigh: [950,1200],
  stateHigh: [null,["white_phosphorus_gas"]],
};
...
chemjsChemicals.titanium = {
  elem: { color: "#e3e5e6", category: "solids", density: 4500, state: "solid", behavior: behaviors.WALL, conduct: 0.5, hardness: 0.7, },
  tempHigh: [1668],
};
...
chemjsChemicals.bromine = {
  elem: { color: "#470500", tick: bromineTick, category: "liquids", density: 3102, state: "liquid", behavior: behaviors.LIQUID, stain: 0.5, },
  tempHigh: [58.8],
  densityHigh: [7.59],
  tempLow: [-7.2],
  toxic: [0.1],
...
elements.bromine_gas = { tick: bromineGasTick, tempLow: 0, stateLow: "bromine", state: "gas", category: "gases" };
...
let indiumTick = function (pixel) {
  ...
  if (pixel.indium_bend > 0) {
    ...
    while (!isEmpty(pixel.x, y + i, true) && pixelMap[pixel.x][y + i].element == "indium") {
      pixelTick(pixelMap[pixel.x][y + i], [["XX", "XX", "XX"], ["XX", "XX", "XX"], ["M2%5", "M1", "M2%5"]]);
      i--;
    }
    pixel.indium_bend = 0;
  }
...
chemjsChemicals.indium = {
  elem: { tick: indiumTick, color: ["#aca9b0", "#ccc7d1", "#d6cbd6"], category: "solids", density: 7290, state: "solid", behavior: behaviors.WALL, conduct: 0.05, hardness: 0.05, superconductAt: -269.74, },
  tempHigh: [156.6],
};
...
chemjsChemicals.iodine = {
  elem: { color: ["#240030", "#15061a", "#752191"], tick: iodineTick, category: "powders", density: 4933, state: "solid", behavior: behaviors.POWDER, stain: 0.01, },
  tempHigh: [113, 183],
  toxic: [0.1],
};

elements.molten_iodine = { behavior: behaviors.LIQUID, color: ["#360147", "#2b0d36", "#9b2ebf"], state: "liquid", category: "liquids", hidden: true, };
elements.iodine_gas = { tick: iodineGasTick, tempLow: 25, stateLow: "iodine", state: "gas", category: "gases", hidden: true, density: 11.27, };
...
chemjsChemicals.thallium = {
  elem: { color: ["#b3bdb4", "#a7b8b0", "#9fa39d"], category: "powders", density: 11873, state: "solid", behavior: behaviors.STURDYPOWDER, conduct: 0.05, hardness: 0.05, },
  tempHigh: [304],
  toxic: [0.2],
};
...
chemjsChemicals.polonium = {
  elem: { color: "#56b870", behavior: ["XX|CR:radiation%10|XX", "CR:radiation%10|CH:lead%0.1|CR:radiation%10", "XX|CR:radiation%10|XX"], tick: function (pixel) { pixel.temp += 1; }, state: "solid", category: "solids", density: 9196, conduct: 0.21, },
  tempHigh: [254],
...
elements.molten_polonium.tick = function (pixel) { pixel.temp += 1; };


chemjsChemicals.stable_polonium = {
  elem: { color: [blendColors("#56b870", "#ff0000"), blendColors("#56b870", "#00ff00"), blendColors("#56b870", "#0000ff")], behavior: behaviors.WALL, state: "solid", category: "solids", density: 9196, conduct: 0.21, hidden: true, },
  tempHigh: [254],
};

chemjsChemicals.astatine = {
  elem: { color: "#5a5e5a", behavior: ["XX|CR:radiation%50|XX", "CR:radiation%50|CH:polonium,explosion%0.1|CR:radiation%50", "M2|M1|M2"], tick: function (pixel) { pixel.temp += 5; }, state: "solid", category: "powders", density: 8910, },
  tempHigh: [301, 336],
...
elements.molten_astatine.tick = function (pixel) { pixel.temp += 5; };
...
chemjsChemicals.stable_astatine = {
  elem: { color: [blendColors("#5a5e5a", "#ff0000"), blendColors("#5a5e5a", "#00ff00"), blendColors("#5a5e5a", "#0000ff")], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 8910, },
  densityHigh: [null, 17.17],
  tempHigh: [301, 336],
  toxic: [0.01],
};
...
chemjsChemicals.radon = {
  elem: { color: "#b6ffb5", behavior: ["M2|M1 AND CR:radiation%10|M2", "M1 AND CR:radiation%10|CH:polonium%0.1|M1 AND CR:radiation%10", "M2|M1 AND CR:radiation%10|M2"], tick: function (pixel) { pixel.temp += 1; }, state: "gas", category: "gases", density: 9.73, conduct: 0.86, colorOn: ["#b224ff", "#cc6caa", "#a16ccc"], },
  tempLow: [-61.7, -71],
...
elements.liquid_radon.tick = function (pixel) { pixel.temp += 1; };

elements.radon_ice = {};
elements.radon_ice.behavior = ["XX|CR:radiation%10|XX", "CR:radiation%10|CH:polonium%0.1|CR:radiation%10", "XX|CR:radiation%10|XX"];
elements.radon_ice.tick = function (pixel) { pixel.temp += 1; };
elements.radon_ice.color = "#789d96";



chemjsChemicals.stable_radon = {
  elem: { color: [blendColors("#b6ffb5", "#ff0000"), blendColors("#b6ffb5", "#00ff00"), blendColors("#b6ffb5", "#0000ff")], behavior: behaviors.GAS, state: "gas", category: "gases", density: 9.73, conduct: 0.86, colorOn: ["#b224ff", "#cc6caa", "#a16ccc"], },
  densityHigh: [null, 9.73],
  tempLow: [-61.7, -71],
};

chemjsChemicals.francium = {
  elem: { color: "#3eff3b", behavior: ["XX|CR:radiation%50|XX", "CR:radiation%50|CH:radon%0.1|CR:radiation%50", "M2|M1|M2"], tick: function (pixel) { pixel.temp += 5; }, state: "solid", category: "powders", density: 2480, conduct: 0.7, },
  tempHigh: [27],
...
elements.molten_francium.tick = function (pixel) { pixel.temp += 5; };
elements.molten_francium.tempLow = 27;


chemjsChemicals.stable_francium = {
  elem: { color: [blendColors("#3eff3b", "#ff0000"), blendColors("#3eff3b", "#00ff00"), blendColors("#3eff3b", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 2480, hidden: true, conduct: 0.7, },
  tempHigh: [27],
};
...
chemjsChemicals.radium = {
  elem: { color: "#3bdeff", behavior: ["XX|CR:radiation%10|XX", "CR:radiation%10|CH:radon%0.1|CR:radiation%10", "M2|M1|M2"], tick: function (pixel) { pixel.temp += 1; }, state: "solid", category: "powders", density: 5500, conduct: 0.4, },
  tempHigh: [700],
...
elements.molten_radium.tick = function (pixel) { pixel.temp += 1; };
elements.molten_radium.tempLow = 700;


chemjsChemicals.stable_radium = {
  elem: { color: [blendColors("#3bdeff", "#ff0000"), blendColors("#3bdeff", "#00ff00"), blendColors("#3bdeff", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 5500, hidden: true, conduct: 0.4, },
  tempHigh: [700],
};


chemjsChemicals.actinium = {
  elem: { color: "#62ebf0", behavior: ["XX|CR:alpha_particle%0.1 AND CR:radiation%10|XX", "CR:alpha_particle%0.1 AND CR:radiation%10|CH:radium%0.02|CR:alpha_particle%0.1 AND CR:radiation%10", "M2|M1|M2"], tick: function (pixel) { pixel.temp += 2.5; }, state: "solid", category: "powders", density: 10000, conduct: 0.225, },
  tempHigh: [1227],
...
elements.molten_actinium.tick = function (pixel) { pixel.temp += 2.5; };
elements.molten_actinium.tempLow = 1227;

chemjsChemicals.stable_actinium = {
  elem: { color: [blendColors("#62ebf0", "#ff0000"), blendColors("#62ebf0", "#00ff00"), blendColors("#62ebf0", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 10000, hidden: true, conduct: 0.225, },
  tempHigh: [1227],
};
...
chemjsChemicals.pure_unstable_thorium = {
  elem: { color:["#599e8a", "#364d4b", "#494d4c", "#428a58", "#658d7a", "#89e0a2"], behavior: ["XX|CR:alpha_particle%0.01|XX", "CR:alpha_particle%0.01|CH:lead%0.001|CR:alpha_particle%0.01", "XX|CR:alpha_particle%0.01|XX"], state: "solid", category: "solids",density: 11700,hardness: 0.7,conduct: 0.235, },
  tempHigh: [1750],
  elemName: "thorium",
...
chemjsChemicals.pure_stable_thorium = {
  elem: { color: [blendColors("#599e8a", "#ff0000"), blendColors("#364d4b", "#00ff00"), blendColors("#494d4c", "#0000ff"), blendColors("#428a58", "#ff0000"), blendColors("#658d7a", "#00ff00"), blendColors("#89e0a2", "#0000ff")], behavior: behaviors.WALL, state: "solid", category: "solids", density: 11700, hardness: 0.7, conduct: 0.235, hidden: true },
  tempHigh: [1750],
...
chemjsChemicals.protactinium = {
  elem: { color: ["#9899a3", "#44464a", "#5a5b5e"], behavior: ["XX|CR:alpha_particle%0.01 AND CR:radiation%2|XX", "CR:alpha_particle%0.01 AND CR:radiation%2|CH:actinium%0.01|CR:alpha_particle%0.01 AND CR:radiation%2", "M2|M1|M2"], state: "solid", category: "powders", density: 15700, hardness: 0.1, conduct: 0.235, },
  tempHigh: [1568],
...
chemjsChemicals.stable_protactinium = {
  elem: { color: [blendColors("#9899a3", "#ff0000"), blendColors("#44464a", "#00ff00"), blendColors("#5a5b5e", "#0000ff")], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 15700, hardness: 0.1, conduct: 0.235, },
  tempHigh: [1568],
};
...
chemjsChemicals.pure_uranium_238 = {
  elem: { color: ["#599e61", "#364d3c", "#494d4a", "#6c8a42", "#798d65", "#b5e089"], behavior: ["XX|CR:alpha_particle%0.01|XX", "CR:alpha_particle%0.01|CH:thorium%0.001|CR:alpha_particle%0.01", "M2|M1|M2"], category: "powders", hidden: true, state: "solid", density: 19100, hardness: 0.6, conduct: 0.235, },
  tempHigh: [1132.2],
...
elements.molten_depleted_uranium = { behavior: ["XX|CR:fire%2.5 AND CR:alpha_particle%0.01|XX", "M2 AND CR:alpha_particle%0.01|CH:thorium%0.001|M2 AND CR:alpha_particle%0.01", "M1|M1|M1"], };

chemjsChemicals.pure_uranium_235 = {
  elem: { color: ["#599e61", "#364d3c", "#494d4a", "#6c8a42", "#798d65", "#b5e089"], behavior: ["XX|CR:radiation%2.5 AND CR:alpha_particle%0.1|XX", "CR:radiation%2.5 AND CR:alpha_particle%0.1|CH:thorium%0.01 AND CH:protactinium%0.005|CR:radiation%2.5 AND CR:alpha_particle%0.1", "M2|M1|M2"], category: "powders", hidden: true, state: "solid", density: 19100, hardness: 0.6, conduct: 0.235, },
  tempHigh: [1132.2],
...
elements.molten_enriched_uranium = { excludeRandom: true, behavior: ["XX|CR:fire%2.5 AND CR:alpha_particle%0.01|XX", "M2 AND CR:alpha_particle%0.01|CH:thorium%0.01 AND CH:protactinium%0.005|M2 AND CR:alpha_particle%0.01", "M1|M1|M1"], };


chemjsChemicals.pure_stable_uranium = {
  elem: { color: [blendColors("#599e61", "#ff0000"), blendColors("#364d3c", "#00ff00"), blendColors("#494d4a", "#0000ff"), blendColors("#6c8a42", "#ff0000"), blendColors("#798d65", "#00ff00"), blendColors("#b5e089", "#0000ff")], behavior: behaviors.POWDER, category: "powders", hidden: true, state: "solid", density: 19100, hardness: 0.6, conduct: 0.235, },
  tempHigh: [1132.2],
...
chemjsChemicals.neptunium = {
  elem: { color: ["#626580", "#3f4a61", "#4a5463"], behavior: ["XX|CR:neutron%0.1 AND CR:radiation%2|XX", "CR:neutron%0.1 AND CR:radiation%2|CH:thorium%0.025|CR:neutron%0.1 AND CR:radiation%2", "XX|CR:neutron%0.1 AND CR:radiation%2|XX"], state: "solid", category: "solids", density: 19380, hardness: 0.7, conduct: 0.2, excludeRandom: true, },
  tempHigh: [639],
...
chemjsChemicals.stable_neptunium = {
  elem: { color: [blendColors("#626580", "#ff0000"), blendColors("#3f4a61", "#00ff00"), blendColors("#4a5463", "#0000ff")], behavior: behaviors.WALL, state: "solid", category: "solids", density: 19380, hardness: 0.7, conduct: 0.2, hidden: true, },
  tempHigh: [639],
};
...
chemjsChemicals.pure_mixed_plutonium = {
  elem: {
    color: ["#5fc29f", "#5d9e7d", "#5b7d6b"], behavior: ["XX|CR:alpha_particle%0.05 AND CR:radiation%2|XX", "CR:alpha_particle%0.05 AND CR:radiation%2|CH:enriched_uranium%0.025 AND CH:americium%0.025|CR:alpha_particle%0.05 AND CR:radiation%2", "XX|CR:alpha_particle%0.05 AND CR:radiation%2|XX"],
    category: "solids", state: "solid", density: 19850, hardness: 0.7, conduct: 0.2, excludeRandom: true,
  },
  tempHigh: [639],
...
elements.molten_plutonium = { excludeRandom: true, behavior: ["XX|CR:fire%2.5 AND CR:alpha_particle%0.05 AND CR:radiation%2|XX", "M2 AND CR:alpha_particle%0.05 AND CR:radiation%2|CH:enriched_uranium%0.01 AND CH:depleted_uranium%0.02|M2 AND CR:alpha_particle%0.05 AND CR:radiation%2", "M1|M1|M1"], };

chemjsChemicals.pure_plutonium_242 = {
  elem: {
    color: ["#5fc29f", "#5d9e7d", "#5b7d6b"], behavior: ["XX|CR:radiation%2|XX", "CR:radiation%2|CH:depleted_uranium%0.025|CR:radiation%2", "XX|CR:radiation%2|XX"],
    category: "solids", hidden: true, state: "solid", density: 19850, hardness: 0.7, conduct: 0.2, excludeRandom: true,
  },
  tempHigh: [639],
...
elements.molten_depleted_plutonium = { excludeRandom: true, behavior: ["XX|CR:fire%2.5 AND CR:radiation%2|XX", "M2 AND CR:radiation%2|CH:depleted_uranium%0.015|M2 AND CR:radiation%2", "M1|M1|M1"], };

chemjsChemicals.pure_plutonium_239 = {
  elem: {
    color: ["#5fc29f", "#5d9e7d", "#5b7d6b"], behavior: ["XX|CR:alpha_particle%0.05 AND CR:radiation%2|XX", "CR:alpha_particle%0.05 AND CR:radiation%2|CH:enriched_uranium%0.035|CR:alpha_particle%0.05 AND CR:radiation%2", "XX|CR:alpha_particle%0.05 AND CR:radiation%2|XX"],
    category: "solids", hidden: true, state: "solid", density: 19850, hardness: 0.7, conduct: 0.2, excludeRandom: true,
  },
  tempHigh: [639],
...
elements.molten_enriched_plutonium = { excludeRandom: true, behavior: ["XX|CR:fire%2.5 AND CR:alpha_particle%0.05 AND CR:radiation%2|XX", "M2 AND CR:alpha_particle%0.05 AND CR:radiation%2|CH:enriched_uranium%0.035|M2 AND CR:alpha_particle%0.05 AND CR:radiation%2", "M1|M1|M1"], };

chemjsChemicals.pure_stable_plutonium = {
  elem: {
    color: ["#5fc29f", "#5d9e7d", "#5b7d6b"], behavior: behaviors.WALL,
    category: "solids", hidden: true, state: "solid", density: 19850, hardness: 0.7, conduct: 0.2
  },
  tempHigh: [639],
...
chemjsChemicals.americium = {
  elem: {
    color: ["#42ebaf", "#59d998", "#d0dbd5"], behavior: ["XX|CR:neutron%0.1 AND CR:radiation%2 AND CR:alpha_particle%2|XX", "CR:neutron%0.1 AND CR:radiation%2 AND CR:alpha_particle%2|CH:neptunium%0.05 AND CH:plutonium%0.05|CR:neutron%0.1 AND CR:radiation%2 AND CR:alpha_particle%2", "XX|CR:neutron%0.1 AND CR:radiation%2 AND CR:alpha_particle%2|XX"],
    state: "solid", category: "solids", density: 12000, hardness: 0.9, conduct: 0.2, excludeRandom: true,
  },
  tempHigh: [1176],
...
chemjsChemicals.stable_americium = {
  elem: { color: [blendColors("#42ebaf", "#ff0000"), blendColors("#59d998", "#00ff00"), blendColors("#d0dbd5", "#0000ff")], behavior: behaviors.WALL, state: "solid", category: "powders", density: 12000, hardness: 0.9, conduct: 0.2, hidden: true, },
  tempHigh: [1176],
};
...
chemjsChemicals.curium = {
  elem: {
    color: ["#fab1f1", "#d6c9d5", "#e0b1d6"], behavior: ["XX|CR:neutron%0.5 AND CR:radiation%1 AND CR:alpha_particle%1|XX", "CR:neutron%0.5 AND CR:radiation%1 AND CR:alpha_particle%1|CH:plutonium%0.075|CR:neutron%0.5 AND CR:radiation%1 AND CR:alpha_particle%1", "XX|CR:neutron%0.5 AND CR:radiation%1 AND CR:alpha_particle%1|XX"],
    state: "solid", category: "solids", density: 13510, hardness: 0.9, conduct: 0.2, excludeRandom: true,
  },
  tempHigh: [1340],
...
chemjsChemicals.stable_curium = {
  elem: { color: [blendColors("#fab1f1", "#ff0000"), blendColors("#d6c9d5", "#00ff00"), blendColors("#e0b1d6", "#0000ff")], behavior: behaviors.WALL, state: "solid", category: "powders", density: 13510, hardness: 0.9, conduct: 0.2, hidden: true, },
  tempHigh: [1340],
};
...
chemjsChemicals.berkelium = {
  elem: {
    color: ["#f2edfa", "#bdbccf", "#d7cae8"], behavior: ["XX|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1|XX", "CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1|CH:californium%0.075|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1", "XX|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1|XX"],
    state: "solid", category: "solids", density: 13250, hardness: 0.9, conduct: 0.2, excludeRandom: true,
  },
  tempHigh: [986],
...
chemjsChemicals.stable_berkelium = {
  elem: { color: [blendColors("#f2edfa", "#ff0000"), blendColors("#bdbccf", "#00ff00"), blendColors("#d7cae8", "#0000ff")], behavior: behaviors.WALL, state: "solid", category: "powders", density: 13250, hardness: 0.9, conduct: 0.2, hidden: true, },
  tempHigh: [986],
};
...
chemjsChemicals.californium = {
  elem: {
    color: ["#dfd0f7", "#bcbade", "#b99be0"], behavior: ["XX|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1|XX", "CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1|CH:curium%0.05 AND CH:einsteinium%0.05|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1", "XX|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1|XX"],
  state: "solid", category: "solids", density: 15100, hardness: 0.9, conduct: 0.2, excludeRandom: true,
  },
  tempHigh: [900],
...
chemjsChemicals.stable_californium = {
  elem: { color: [blendColors("#dfd0f7", "#ff0000"), blendColors("#bcbade", "#00ff00"), blendColors("#b99be0", "#0000ff")], behavior: behaviors.WALL, state: "solid", category: "powders", density: 15100, hardness: 0.9, conduct: 0.2, hidden: true, },
  tempHigh: [900],
};
...
chemjsChemicals.einsteinium = {
  elem: {
    ...
    state: "solid", category: "solids", density: 8840, hardness: 0.9, conduct: 0.2, excludeRandom: true,
  },
  tempHigh: [1133],
...
chemjsChemicals.stable_einsteinium = {
  elem: { color: [blendColors("#3aa6c2", "#ff0000"), blendColors("#b8edf1", "#00ff00"), blendColors("#83d9e4", "#0000ff")], behavior: behaviors.WALL, state: "solid", category: "powders", density: 8840, hardness: 0.9, conduct: 0.2, hidden: true, },
  tempHigh: [1133],
};
...
chemjsChemicals.fermium = {
  elem: {
    color: ["#c8a7fc", "#cecbf2", "#d5bff2"], behavior: ["XX|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1|XX", "CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1|CH:californium%0.1|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1", "XX|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1|XX"],
    state: "solid", category: "solids", density: 9710, hardness: 0.9, conduct: 0.2, excludeRandom: true,
  },
  tempHigh: [1800],
...
chemjsChemicals.stable_fermium = {
  elem: { color: [blendColors("#c8a7fc", "#ff0000"), blendColors("#cecbf2", "#00ff00"), blendColors("#d5bff2", "#0000ff")], behavior: behaviors.WALL, state: "solid", category: "powders", density: 9710, hardness: 0.9, conduct: 0.2, hidden: true, },
  tempHigh: [1800],
};
...
chemjsChemicals.copernicium = {
  elem: {
    ...
    state: "liquid", category: "liquids", density: 14010, hardness: 0.999, conduct: 0.2, excludeRandom: true, tick: function (pixel) { pixel.temp += 50; },
  },
  tempHigh: [67],
  tempLow: [10],
...
chemjsChemicals.stable_copernicium = {
  elem: {
    color: [blendColors("#a7fcbc", "#ff0000"), blendColors("#8cc299", "#00ff00"), blendColors("#9db9c2", "#0000ff")], behavior: behaviors.LIQUID,
    state: "liquid", category: "liquids", density: 14010, conduct: 0.2, hidden: true,
  },
  tempHigh: [67],
  tempLow: [10],
...
chemjsChemicals.nihonium = {
  elem: {
    color: ["#c94a0a"], /*spike viper reference*/ behavior:["XX|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1 AND CR:rad_pop%1|XX", "CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1 AND CR:rad_pop%1|CH:transactinide_fallout%1|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1 AND CR:rad_pop%1", "XX|M1|XX"],
    state: "solid", category: "powders", density: 16000, hardness: 0.999, conduct: 0.2, excludeRandom: true, tick: function (pixel) { pixel.temp += 50; },
  },
  tempHigh: [430],
...
chemjsChemicals.stable_nihonium = {
  elem: {
    color: [blendColors("#c94a0a", "#ff0000"), blendColors("#c94a0a", "#00ff00"), blendColors("#c94a0a", "#0000ff")],behavior: behaviors.STURDYPOWDER,
    state: "solid", category: "powders", density: 16000, hardness: 0.999, conduct: 0.2,  hidden: true,
  },
  tempHigh: [430],
  toxic: [0.02],
};
...
chemjsChemicals.flerovium = {
  elem: {
    color: ["#a8ffe2", "#7ddbcd", "#9dc2b1"], behavior: ["XX|CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1 AND CR:rad_pop%1|XX", "M2 AND CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1 AND CR:rad_pop%1|CH:copernicium%1|M2 AND CR:neutron%1 AND CR:radiation%1 AND CR:alpha_particle%1 AND CR:rad_pop%1", "M1|M1|M1"],
    state: "liquid", category: "liquids", density: 11400, hardness: 0.999, conduct: 0.2, excludeRandom: true, tick: function (pixel) { pixel.temp += 50; },
  },
  tempHigh: [107],
  tempLow: [-73],
...
chemjsChemicals.stable_flerovium = {
  elem: {
    color: [blendColors("#a8ffe2", "#ff0000"), blendColors("#7ddbcd", "#00ff00"), blendColors("#9dc2b1", "#0000ff")], behavior: behaviors.LIQUID,
    state: "liquid", category: "liquids", density: 11400, conduct: 0.2, hidden: true,
  },
  tempHigh: [107],
  tempLow: [-73],
...
chemjsChemicals.moscovium = {
  elem: {
    color: ["#8a3683", "#b0339b", "#d14fcd"], behavior: ["XX|CR:neutron%2 AND CR:radiation%2 AND CR:alpha_particle%2 AND CR:rad_pop%2|XX", "CR:neutron%2 AND CR:radiation%2 AND CR:alpha_particle%2 AND CR:rad_pop%2|CH:nihonium%1|CR:neutron%2 AND CR:radiation%2 AND CR:alpha_particle%2 AND CR:rad_pop%2", "XX|CR:neutron%2 AND CR:radiation%2 AND CR:alpha_particle%2 AND CR:rad_pop%2|XX"],
    state: "solid", category: "solids", density: 13500, hardness: 0.999, conduct: 0.2, excludeRandom: true, tick: function (pixel) { pixel.temp += 100; },
  },
  tempHigh: [400],
...
chemjsChemicals.stable_moscovium = {
  elem: {
    color: [blendColors("#c94a0a", "#ff0000"), blendColors("#c94a0a", "#00ff00"), blendColors("#c94a0a", "#0000ff")],behavior: behaviors.WALL,
    state: "solid", category: "solids", density: 13500, conduct: 0.2,  hidden: true,
  },
  tempHigh: [400],
};
...
chemjsChemicals.livermorium = {
  elem: {
    color: ["#c9c26b", "#5ee04c", "#8bc253"], behavior: ["XX|CR:neutron%10 AND CR:radiation%10 AND CR:alpha_particle%10 AND CR:rad_pop%10 AND CR:n_explosion%0.1|XX", "CR:neutron%10 AND CR:radiation%10 AND CR:alpha_particle%10 AND CR:rad_pop%10 AND CR:n_explosion%0.1|CH:flerovium%1|CR:neutron%10 AND CR:radiation%10 AND CR:alpha_particle%10 AND CR:rad_pop%10 AND CR:n_explosion%0.1", "XX|CR:neutron%10 AND CR:radiation%10 AND CR:alpha_particle%10 AND CR:rad_pop%10 AND CR:n_explosion%0.1|XX"],
    state: "solid", category: "solids", density: 12900, hardness: 0.999, conduct: 0.2, excludeRandom: true, tick: function (pixel) { pixel.temp += 100; },
  },
  tempHigh: [455],
...
chemjsChemicals.stable_livermorium = {
  elem: {
    color: [blendColors("#c94a0a", "#ff0000"), blendColors("#c94a0a", "#00ff00"), blendColors("#c94a0a", "#0000ff")], behavior: behaviors.WALL,
    state: "solid", category: "solids", density: 12900, conduct: 0.2, hidden: true
  },
  tempHigh: [455],
};
...
chemjsChemicals.tennessine = {
  elem: {
    color: ["#4f4c42"], behavior: ["XX|CR:neutron%15 AND CR:radiation%15 AND CR:alpha_particle%15 AND CR:rad_pop%15 AND CR:n_explosion%0.2|XX", "CR:neutron%15 AND CR:radiation%15 AND CR:alpha_particle%15 AND CR:rad_pop%15 AND CR:n_explosion%0.2|CH:moscovium%1|CR:neutron%15 AND CR:radiation%15 AND CR:alpha_particle%15 AND CR:rad_pop%15 AND CR:n_explosion%0.2", "M2|M1|M2"],
    state: "solid", category: "powders", density: 7200, hardness: 0.999, conduct: 0.1, excludeRandom: true, tick: function (pixel) { pixel.temp += 100; },
  },
  tempHigh: [425],
...
chemjsChemicals.stable_tennessine = {
  elem: {
    color: [blendColors("#4f4c42", "#ff0000"), blendColors("#4f4c42", "#00ff00"), blendColors("#4f4c42", "#0000ff")], behavior: behaviors.POWDER,
    state: "solid", category: "powders", density: 7200, conduct: 0.1, hidden: true
  },
  tempHigh: [425],
  toxic: [0.01],
};
...
chemjsChemicals.oganesson = {
  elem: {
    color: ["#c4ccc6", "#9ea39f", "#8e9294"], behavior: ["XX|CR:neutron%20 AND CR:radiation%20 AND CR:alpha_particle%20 AND CR:rad_pop%20 AND CR:n_explosion%1|XX", "CR:neutron%20 AND CR:radiation%20 AND CR:alpha_particle%20 AND CR:rad_pop%20 AND CR:n_explosion%1|CH:livermorium%1|CR:neutron%20 AND CR:radiation%20 AND CR:alpha_particle%20 AND CR:rad_pop%20 AND CR:n_explosion%1", "XX|CR:neutron%20 AND CR:radiation%20 AND CR:alpha_particle%20 AND CR:rad_pop%20 AND CR:n_explosion%1|XX"],
    state: "solid", category: "solids", density: 7200, hardness: 0.999, excludeRandom: true, tick: function (pixel) { pixel.temp += 100; },
  },
  tempHigh: [52, 177],
...
chemjsChemicals.stable_oganesson = {
  elem: {
    color: [blendColors("#c4ccc6", "#ff0000"), blendColors("#9ea39f", "#00ff00"), blendColors("#8e9294", "#0000ff")], behavior: behaviors.WALL,
    state: "solid", category: "solids", density: 7200, conduct: 0.1, hidden: true
  },
  tempHigh: [52, 177],
  densityHigh: [null, 12.222],
};
...
chemjsChemicals.ununennium = {
  elem: {
    ...
    state: "liquid", category: "liquids", density: 3000, hardness: 0.999, conduct: 0.2, excludeRandom: true, tick: function (pixel) { pixel.temp += 150; },
  },
  tempHigh: [630],
  tempLow: [15],
...
chemjsChemicals.stable_ununennium = {
  elem: {
    color: [blendColors("#c0eb9b", "#ff0000"), blendColors("#82e082", "#00ff00"), blendColors("#b8c29d", "#0000ff")], behavior: behaviors.LIQUID,
    state: "liquid", category: "liquids", density: 14010, conduct: 0.2, hidden: true,
  },
  tempHigh: [630],
  tempLow: [15],
...
chemjsChemicals.unbinilium = {
  elem: {
    color: ["#faf069", "#fcf0c7", "#edcd3e"],behavior: ["XX|CR:neutron%25 AND CR:radiation%25 AND CR:alpha_particle%25 AND CR:rad_pop%25 AND CR:n_explosion%2|XX", "CR:neutron%25 AND CR:radiation%25 AND CR:alpha_particle%25 AND CR:rad_pop%25 AND CR:n_explosion%2|CH:oganesson%1|CR:neutron%25 AND CR:radiation%25 AND CR:alpha_particle%25 AND CR:rad_pop%25 AND CR:n_explosion%2", "M2|M1|M2"],
    state: "solid", category: "powders", density: 7000, hardness: 0.999, conduct: 0.2, excludeRandom: true, tick: function (pixel) { pixel.temp += 150; },
  },
  tempHigh: [680],
...
chemjsChemicals.stable_unbinilium = {
  elem: {
    color: [blendColors("#faf069", "#ff0000"), blendColors("#fcf0c7", "#00ff00"), blendColors("#edcd3e", "#0000ff")], behavior: behaviors.POWDER,
    state: "solid", category: "powders", density: 7000, conduct: 0.1, hidden: true
  },
  tempHigh: [680],
  toxic: [0.01],
};
...
chemjsChemicals.generic_acid = {
  elem: { name: "acid", color: "#80d488", behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1020, burn: 30, burnTime: 1, hidden: true },
  tempHigh: [110, 400],
  stateHigh: [null, ["fire"]],
  densityHigh: [1],
  tempLow: [-10],
};
elements.generic_acid_gas = { name: "acid_gas", behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases"};
elements.generic_acid_ice = { name: "acid_ice" };
...
chemjsChemicals.hydrofluoric_acid = {
  elem: { color: ["#c8cf91", "#efff5e", "#a0cc39"], tick: hydrofluoricAcidTick, behavior: behaviors.LIQUID, state: "liquid", category: "liquids", density: 1020, stain: 0.005, },
  densityHigh: [1.63],
  tempHigh: [100, 400],
  stateHigh: [null, ["fire"]],
  tempLow: [-58.88],
...
elements.hydrofluoric_acid_gas = { tick: hydrofluoricAcidTick, behavior: behaviors.GAS, category: "gases", stain: 0.005 };
...
chemjsChemicals.hydrogen_fluoride = {
  elem: { color: "#f2f28d", behavior: behaviors.GAS, tick: hydrogenFluorideTick, state: "gas", category: "gases", density: 1.7, stain: 0.005 },
  densityLow: [990],
  tempLow: [19.5, -83.6],
...
elements.liquid_hydrogen_fluoride = { tick: hydrogenFluorideTick, behavior: behaviors.LIQUID, category: "liquids", stain: 0.005 };
...
chemjsChemicals.fluoroboric_acid = {
  elem: { color: ["#3bffdb", "#00caaf", "#56c4a3"], tick: fluoroboricAcidTick, behavior: behaviors.LIQUID, state: "liquid", category: "liquids", density: 1020, stain: 0.005, hidden: true,},
  densityHigh: [1],
  tempHigh: [100, 1000],
  stateHigh: [null, ["fire"]],
  tempLow: [0],
...
elements.fluoroboric_acid_gas = { tick: fluoroboricAcidTick, behavior: behaviors.GAS, category: "gases", stain: 0.005 };




chemjsChemicals.nitric_acid = {
  elem: { color: ["#91993c", "#6b7041", "#5f614b"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1500 },
  tempHigh: [83, 400],
  stateHigh: [null, ["fire"]],
  densityHigh: [1.5],
  tempLow: [-42],
...
elements.nitric_acid_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases" };


chemjsChemicals.hexafluorosilicic_acid = {
  elem: { color: ["#ebeed8", "#f9ffc2", "#c7e189"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1460, hidden: true },
  tempHigh: [108.5, 400],
  stateHigh: [null, ["fire"]],
  densityHigh: [5.89],
  tempLow: [19],
...
elements.hexafluorosilicic_acid_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases", hidden: true };


chemjsChemicals.phosphoric_acid = {
  elem: { color: ["#a1a3ed", "#8f91db", "#bab5f5"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1684, viscosity: 26.7, },
  tempHigh: [120, 1000],
  stateHigh: [null, ["fire"]],
  densityHigh: [4],
  tempLow: [0],
...
elements.phosphoric_acid_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases" };


chemjsChemicals.sulfuric_acid = {
  elem: { color: ["#e9e05e", "#c2bd7a", "#9e9c7b"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1830, viscosity: 26.7, },
  tempHigh: [337, 600],
  stateHigh: [null, ["fire"]],
  densityHigh: [1.26],
  tempLow: [10],
...
elements.sulfuric_acid_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases" };


elements.acid.name = "hydrochloric_acid";
elements.acid.forceAutoGen = true;
elements.acid_gas.name = "hydrochloric_acid_gas";
elements.acid_ice = { name: "hydrochloric_acid_ice" };
...
chemjsChemicals.perchloric_acid = {
  elem: { color: ["#ff963b", "#ca6800", "#c48a56"], tick: perchloricAcidTick, behavior: behaviors.LIQUID, state: "liquid", category: "liquids", density: 1768, stain: 0.01, viscosity: 200, hardness: 0.4, hidden: true, },
  densityHigh: [1.63],
  tempHigh: [75, 100],
  stateHigh: [null, ["fire"]],
  tempLow: [-112],
...
elements.perchloric_acid_gas = { tick: perchloricAcidTick, behavior: behaviors.GAS, category: "gases", stain: 0.01, hardness: 0.4, };


chemjsChemicals.hydrobromic_acid = {
  elem: { color: ["#ff3b3b", "#ca0000", "#9e7b7b"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1100, hidden: true, },
  tempHigh: [100, 1000],
  stateHigh: [null, ["fire"]],
  densityHigh: [3.31],
  tempLow: [0],
...
elements.hydrobromic_acid_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases" };
...
chemjsChemicals.hydrogen_iodide = {
  elem: { color: "#aa8df2", behavior: behaviors.GAS, state: "gas", category: "gases", density: 2.85, stain: 0.005 },
  densityLow: [2850],
  tempLow: [-35.4, -50.8],
...
chemjsChemicals.hydroiodic_acid = {
  elem: { color:["#9670ff", "#da6afc", "#a77af5", "#9670ff", "#da6afc", "#a77af5", "#633a1d"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1150, hidden: true,},
  tempHigh: [100, 1000],
  stateHigh: [null, ["fire"]],
  densityHigh: [2.85],
  tempLow: [0],
...
elements.hydroiodic_acid_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases" };



chemjsChemicals.hydroastatic_acid = {
  elem: { color: [blendColors("#5a5e5a", "#ff0000", 0.25), blendColors("#5a5e5a", "#00ff00", 0.25), blendColors("#5a5e5a", "#0000ff", 0.25)], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1200, hidden: true },
  tempHigh: [100, 1000],
  stateHigh: [null, ["fire"]],
  densityHigh: [8.62],
  tempLow: [-3],
...
elements.hydroastatic_acid_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases" };
...
chemjsChemicals.generic_base = {
  elem: { color: "#d48092", behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1020, hidden: true },
  elemName: "bases",
  tempHigh: [110, 400],
  stateHigh: [null, ["fire"]],
  densityHigh: [1],
...
elements.base_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases"};


chemjsChemicals.sodium_hydride = {
  elem: { color: ["#9e9e9e", "#4f4f4f", "#616161", "#454545"], behavior: behaviors.CAUSTIC, category: "powders", state: "solid", density: 1390, hidden: true, burn: 75, burnTime: 120, fireColor: "#ffff00",},
  tempHigh: [638],
...
chemjsChemicals.sodium_methoxide = {
  elem: { color: ["#c4c4c4", "#8c8c8c", "#ababab", "#787878"], behavior: behaviors.CAUSTIC, category: "powders", state: "solid", density: 970, hidden: true, burn: 5, burnTime: 100, fireColor: "#ffff00",},
  tempHigh: [127],
...
elements.molten_sodium_methoxide = { behavior: behaviors.MOLTEN_CAUSTIC };

chemjsChemicals.sodium_hydroxide_solution = {
  elem: { color: ["#fc3bff", "#c000ca", "#9b7b9e"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1050 },
...
elements.sodium_hydroxide_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases"};


chemjsChemicals.sodium_hydroxide = {
  elem: { color: "#ffe8ff", behavior: behaviors.CAUSTIC, category: "powders", tempHigh: 323, state: "solid", density: 2130, hidden: true, alias: "sodium hydroxide powder", },
  elemName: "caustic_soda",
  tempHigh: [323],
  reactionProduct: { anionBase: "hydroxide", cationBase: "sodium_ion" },
  categories: ["bases", "sodium_ion", "hydroxide", "caustic"],
};
elements.molten_caustic_soda = { behavior: behaviors.MOLTEN_CAUSTIC };



chemjsChemicals.potassium_hydroxide_solution = {
  elem: { color: ["#3bc4ff", "#0062ca", "#7b949e"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1075 },
...
elements.potassium_hydroxide_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases"};
...
elements.molten_caustic_potash = { behavior: behaviors.MOLTEN_CAUSTIC };


chemjsChemicals.francium_hydroxide_solution = {
  elem: { color: [blendColors("#863bff", "#ff0000"), blendColors("#4d00ca", "#00ff00"), blendColors("#897b9e", "#0000ff")], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1200, hidden: true },
...
elements.francium_hydroxide_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases"};



chemjsChemicals.francium_hydroxide = {
  elementNames: ["chemical!francium_hydroxide_solution"],
  elem: { color: [blendColors("#e8ede8", "#ff0000"), blendColors("#e8ede8", "#00ff00"), blendColors("#e8ede8", "#0000ff")], behavior: behaviors.CAUSTIC, category: "powders", state: "solid", density: 5100/*made up*/, hidden: true },
...
elements.molten_francium_hydroxide_powder = { behavior: behaviors.MOLTEN_CAUSTIC };



chemjsChemicals.ununennium_hydroxide_solution = {
  elem: { color: [blendColors("#eb3bff", "#ff0000"), blendColors("#eb3bff", "#00ff00"), blendColors("#eb3bff", "#0000ff")], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1200, hidden: true },
...
elements.ununennium_hydroxide_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases"};



chemjsChemicals.ununennium_hydroxide = {
  elementNames: ["chemical!ununennium_hydroxide_solution"],
  elem: { color: [blendColors("#c8cdc8", "#ff0000"), blendColors("#c8cdc8", "#00ff00"), blendColors("#c8cdc8", "#0000ff")], behavior: behaviors.CAUSTIC, category: "powders", state: "solid", density: 5100/*made up*/, hidden: true },
...
elements.molten_ununennium_hydroxide_powder = { behavior: behaviors.MOLTEN_CAUSTIC };

chemjsChemicals.red_mud = {
  elem: { color: ["#ab3d24", "#cc5d2d", "#a81b1b"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 5200, viscosity: 1000000, hidden: true },
  tempHigh: [1600],
  stateHigh: [null],
  densityHigh: [3],
  tempLow: [-10],
...
elements.red_mud_gas = { behavior: ["M1|DB%5 AND M1|M1", "DB%5 AND M1|XX|DB%5 AND M1", "DB%5 AND M1|DB%10 AND M1|DB%5 AND M1"], category: "gases"};
...
chemjsChemicals.boron_trioxide = {
  elem: { color: "#c6c5c7", behavior: behaviors.POWDER, category: "powders", density: 2550, state: "solid", fireColor: ["#34eb67", "#5ceb34"], hidden: true, },
  tempHigh: [450],
  categories: ["insoluble", "boron_ion", "oxide"],
};

chemjsChemicals.boric_acid = {
  elem: { color: "#fbffeb", behavior: behaviors.POWDER, category: "powders", density: 1435, state: "solid", fireColor: ["#34eb67", "#5ceb34"], },
  tempHigh: [170],
...
chemjsChemicals.ammonium_nitrate_solution = {
  elem: { color: blendColors("#e6c3a1", "#2167ff", 0.5), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1010, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.ammonium_chloride = {
  elem: { color: "#daeced", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 1519, hidden: true },
  tempHigh: [338],
...
chemjsChemicals.ammonium_chloride_solution = {
  elem: { color: ["#a299c7", "#7e76b3"], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1008, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.ammonium_perchlorate = {
  elem: { color: "#edcfca", behavior: behaviors.POWDER, state: "solid", category: "weapons", density: 1950, burn: 100, burnTime: 100, burnInto: "big_explosion", },
  tempHigh: [200],
...
chemjsChemicals.ammonium_perchlorate_solution = {
  elem: { color: blendColors("#edcfca", "#2167ff", 0.5), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1020, hidden: true, conduct: 0.1, stain: -0.66, burn: 1, burnTime: 100, burnInto: "big_explosion", },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_borohydride = {
  elem: { color: ["#deded3", "#ebebc7", "#fcfced", "#d9d9d9"], behavior: behaviors.CAUSTIC, state: "solid", category: "powders", density: 1070, fireColor: ["#34eb67", "#5ceb34"] },
  tempHigh: [400],
...
chemjsChemicals.sodium_borohydride_solution = {
  elem: { color: ["#ababb7", "#9d9dc1", "#bdbdcb", "#a8a898"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1005, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_octahydrotriborate = {
  elem: { color: ["#ded3de", "#ebc7eb", "#fbedfb", "#e3cce3"], behavior: behaviors.POWDER, category: "powders", density: 1070/*wild guess*/, state: "solid", fireColor: ["#ffff00", "#34eb67", "#5ceb34"], burn: 5, burnTime: 10, burnInto: "boron_trioxide", hidden: true, },
...
chemjsChemicals.sodium_dodecaborate = {
  elem: { color: "#f5aef5", behavior: behaviors.POWDER, category: "powders", density: 1050/*wild guess*/, state: "solid", fireColor: ["#ffff00", "#34eb67", "#5ceb34"], burn: 1, burnTime: 10, burnInto: "boron_trioxide", hidden: true, },
  tempHigh: [700], //wild guess
  categories: ["insoluble", "sodium_ion", "dodecaborate"],
};

chemjsChemicals.sodium_bromoheptahydrotriborate = {
  elem: { color: ["#ded9d3", "#ebd9c7", "#fbf4ed", "#e3d5cc"], behavior: behaviors.POWDER, category: "powders", density: 1090/*wild guess*/, state: "solid", fireColor: ["#ffff00", "#34eb67", "#5ceb34"], burn: 5, burnTime: 10, burnInto: "boron_trioxide", hidden: true, },
...
chemjsChemicals.sodium_tetrafluoroborate = {
  elem: { color: ["#deded3", "#ebebc7", "#fcfced", "#d9d9d9"], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2470, hidden: true, fireColor: ["#34eb67", "#5ceb34"] },
  tempHigh: [384],
...
chemjsChemicals.sodium_tetrafluoroborate_solution = {
  elem: { color: ["#ababb7", "#9d9dc1", "#bdbdcb", "#a8a898"], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1012, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_carbonate = {
  elem: { color: "#d8dae6", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2540, hidden: true, },
  tempHigh: [851],
...
chemjsChemicals.sodium_carbonate_solution = {
  elem: { color: ["#c5c1d6", "#afacc2"], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1010, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_bicarbonate_solution = {
  elem: { color: "#7494db", behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1026, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_acetate_solution = {
  elem: { color: "#7ea2f2", behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1028, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_fluoride = {
  elem: { color: ["#8aebce", "#b9edde"], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2558, hidden: true, },
  tempHigh: [993],
...
chemjsChemicals.sodium_fluoride_solution = {
  elem: { color:  ["#8ad0eb", "#b9e3ed"], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1012, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_aluminate = {
  elem: { color: ["#e6c9b3", "#ebc8ad"], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 1500, hidden: true, },
  tempHigh: [1650],
...
chemjsChemicals.sodium_aluminate_solution = {
  elem: { color: ["#bdb3e6", "#b4adeb"], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1005, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_hexafluoroaluminate = {
  elemName: "cryolite",
  elem: { color: ["#9ab6d9", "#dae4f0"], behavior: behaviors.POWDER, category: "land", density: 2900, state: "solid", },
  tempHigh: [950],
...
chemjsChemicals.cryolite_mixture = {
  elem: { color: [blendColors("#9ab6d9", "#ebf4ff"), blendColors("#dae4f0", "#e3fdff")], behavior: behaviors.POWDER, category: "powders", density: 2910, state: "solid", hidden: true, },
  tempHigh: [950],
};

chemjsChemicals.cryolite_solution = {
  elem: { color: [blendColors(blendColors("#9ab6d9", "#ebf4ff"), "#d1cbcb"), blendColors(blendColors("#dae4f0", "#e3fdff"), "#d1cbcb")], behavior: behaviors.POWDER, category: "powders", density: 2920, state: "solid", hidden: true, },
  tempHigh: [950],
};


chemjsChemicals.sodium_sulfate = {
  elem: { color: "#f3f2f5", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2664, hidden: true, },
  tempHigh: [884],
...
chemjsChemicals.sodium_sulfate_solution = {
  elem: { color: blendColors("#f3f2f5", "#2167ff", 0.5), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1013, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_chlorate = {
  elem: { color: "#cff0cc", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2490, hidden: true, },
  tempHigh: [255],
...
chemjsChemicals.sodium_chlorate_solution = {
  elem: { color: blendColors("#cff0cc", "#2167ff", 0.25), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1011, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_perchlorate = {
  elem: { color: "#c0d3be", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2499, hidden: true, },
  tempHigh: [468],
...
chemjsChemicals.sodium_perchlorate_solution = {
  elem: { color: blendColors("#c0d3be", "#2167ff", 0.25), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1011, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.magnesium_oxide = {
  elem: { color: "#f0f0f0", behavior: behaviors.POWDER, category: "powders", density: 3600, state: "solid", },
  tempHigh: [2852],
  categories: ["insoluble", "magnesium_ion", "oxide"],
};

chemjsChemicals.magnesium_fluoride = {
  elem: { color: ["#aaabae", "#a9adae"], behavior: behaviors.POWDER, category: "powders", density: 3148, state: "solid", hidden: true, },
  tempHigh: [1263],
...
chemjsChemicals.magnesium_sulfate_solution = {
  ...
  elem: { color: [blendColors("#f2f2f2", "#2167ff", 0.75), blendColors("#d6d6d6", "#2167ff", 0.75)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1015, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.magnesium_chloride = {
  elem: { color: "#bfbfbf", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2320, fireColor: "#f9ebff", hidden: true, },
  tempHigh: [714],
...
chemjsChemicals.magnesium_chloride_solution = {
  elem: { color: blendColors("#bfbfbf", "#2167ff", 0.75), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1015, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.bauxite = {
  elem: { color: ["#915a30", "#cc7533"], behavior: behaviors.SUPPORTPOWDER, category: "land", state: "solid", density: 2420, },
  tempHigh: [300],
};
...
chemjsChemicals.bauxite_solution = {
  ...
  elem: { color: ["#696380", "#7a759e"], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1005, hidden: true, conduct: 0.05, stain: 0.33, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.aluminum_hydroxide = {
  elem: { color: "#d1cbcb", behavior: behaviors.STURDYPOWDER, category: "powders", density: 2420, state: "solid", hidden: true, },
  tempHigh: [300],
...
chemjsChemicals.aluminum_oxide = {
  elemName: "alumina",
  elem: { color: "#ebe1e1", behavior: behaviors.STURDYPOWDER, category: "powders", density: 3987, state: "solid", },
  tempHigh: [2072],
  categories: ["insoluble", "aluminum_ion", "oxide"],
};

chemjsChemicals.aluminum_fluoride = {
  elem: { color: "#ebe1e1", behavior: behaviors.POWDER, category: "powders", density: 3100, state: "solid", hidden: true, },
  tempHigh: [1290],
...
chemjsChemicals.potassium_carbonate = {
  elem: { color: "#e2e1e8", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2430, hidden: true },
  tempHigh: [891],
...
chemjsChemicals.potassium_carbonate_solution = {
  elem: { color: blendColors("#e2e1e8", "#2167ff", 0.75), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1024, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.potassium_nitrate = {
  elemName: "niter",
  elem: { color: "#f0efcc", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2109 },
  tempHigh: [334],
  stateHigh: [["fire"]],
...
chemjsChemicals.potassium_nitrate_solution = {
  ...
  elem: { color: blendColors("#f0efcc", "#2167ff", 0.75), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1011, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.potassium_fluoride = {
  elem: { color: "#e8e8e1", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2480, hidden: true },
  tempHigh: [858],
...
chemjsChemicals.potassium_fluoride_solution = {
  elem: { color: blendColors("#e8e8e1", "#2167ff", 0.75), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1020, hidden: true, conduct: 0.5, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.potassium_sulfate = {
  elem: { color: "#f0d8cc", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2660, hidden: true },
  tempHigh: [1069],
...
chemjsChemicals.potassium_sulfate_solution = {
  elemName: "niter_solution",
  elem: { color: blendColors("#f0d8cc", "#2167ff", 0.75), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1012, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.potassium_chloride_solution = {
  elem: { color: "#416ed1", behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1026, conduct: 0.1, stain: -0.66, },
...
chemjsChemicals.calcium_fluoride = {
  elemName: "fluorite",
  elem: { color: ["#8fc4f2", "#d0e5f7"], behavior: behaviors.POWDER, category: "land", density: 3180, state: "solid", },
  tempHigh: [1418],
  categories: ["insoluble", "calcium_ion", "fluoride"],
};

chemjsChemicals.apatite = {
  elem: { color: ["#48b593", "#3adec0", "#29c4cc"], behavior: behaviors.POWDER, category: "land", density: 3160, state: "solid", },
  tempHigh: [1670],
};

chemjsChemicals.tricalcium_phosphate = {
  elem: { color: "#b9e9ed", behavior: behaviors.POWDER, category: "powders", density: 3140, state: "solid", hidden: true,},
  tempHigh: [1670],
...
chemjsChemicals.calcium_sulfate = {
  elemName: "chalk",
  elem: { color: ["#e0e0e0", "#bfbfbf"], behavior: behaviors.POWDER, category: "land", density: 2320, state: "solid", stain: 0.05, },
  tempHigh: [1460],
...
chemjsChemicals.titanium_dioxide = {
  elemName: "rutile",
  elem: { color: "#522614", behavior: behaviors.POWDER, category: "land", density: 4240, state: "solid", },
  tempHigh: [1843],
  categories: ["insoluble", "titanium_iv", "oxide"],
};

chemjsChemicals.titanium_trichloride = {
  elem: { color: "#c71585", behavior: behaviors.WALL, state: "solid", category: "solids", density: 2640, burn: 20, fireColor: "#f9ebff", },
  tempHigh: [440],
...
chemjsChemicals.titanium_trichloride_solution = {
  elem: { color: blendColors("#c71585", "#2167ff", 0.4), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1020, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.iron_dichloride = {
  elem: { color: ["#207d09", "#b51259"], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2900 },
  tempHigh: [307.6],
...
chemjsChemicals.iron_dichloride_solution = {
  elem: { color: [blendColors("#207d09", "#2167ff", 0.5), blendColors("#b51259", "#2167ff", 0.5)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1030, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.sodium_bromide = {
  elem: { color: ["#f5f4ed", "#f2f2eb"], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 3210 },
  tempHigh: [747],
...
chemjsChemicals.sodium_bromide_solution = {
  elem: { color: blendColors("#f5f4ed", "#2167ff", 0.75), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1040, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.potassium_bromide = {
  elem: { color: ["#fccaca", "#f7cbcb"], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2740 },
  tempHigh: [734],
...
chemjsChemicals.potassium_bromide_solution = {
  elem: { color: blendColors("#fccaca", "#2167ff", 0.75), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1050, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.silver_nitrate = {
  elem: { color: ["#cad7fc", "#cbd2f7"], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 4350, hidden: true },
  tempHigh: [209, 440],
...
chemjsChemicals.silver_nitrate_solution = {
  elem: { color: blendColors("#cad7fc", "#2167ff", 0.5), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1060, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.silver_bromide = {
  elem: { color: ["#fcfcca", "#f7f24f"], tick: silverBromideTick, behavior: behaviors.POWDER, category: "powders", density: 6470, state: "solid", },
  tempHigh: [430],
...
chemjsChemicals.indium_nitrate = {
  elem: { color: "#eddaf5", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 4380, hidden: true },
  tempHigh: [150],
...
chemjsChemicals.indium_nitrate_solution = {
  elem: { color: blendColors("#eddaf5", "#2167ff", 0.5), behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1050, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.indium_oxide = {
  elem: { color: "#ebc7e4", behavior: behaviors.POWDER, category: "powders", density: 7179, state: "solid", hidden: true },
  tempHigh: [1910],
  categories: ["insoluble", "indium_iii", "oxide"],
};

chemjsChemicals.indium_hydroxide = {
  elem: { color: "#e3f294", behavior: behaviors.POWDER, category: "powders", density: 4380, state: "solid", hidden: true },
  tempHigh: [150],
...
chemjsChemicals.indium_chloride = {
  elem: { color: "#f8ebff", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 3460, hidden: true },
  tempHigh: [586],
...
chemjsChemicals.indium_chloride_solution = {
  elem: { color: "#7e70ff", behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1030, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.thallium_oxide = {
  elem: { color: "#2b2b2a", behavior: behaviors.POWDER, category: "powders", density: 10450, state: "solid", hidden: true },
  tempHigh: [596],
...
chemjsChemicals.thallium_hydroxide = {
  elem: { color: ["#f0f564","#f7ee45"], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 7440, hidden: true },
  tempHigh: [139],
...
chemjsChemicals.thallium_hydroxide_solution = {
  elem: { color: "#a4c244", behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1035, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.thallium_sulfide = {
  elem: { color: "#20201f", behavior: behaviors.POWDER, category: "powders", density: 8390, state: "solid", hidden: true, conduct: 0.5, },
  tempHigh: [448],
...
chemjsChemicals.thallium_sulfate = {
  elem: { color: "#fafaf0", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 6770, hidden: true },
  tempHigh: [632],
...
chemjsChemicals.thallium_sulfate_solution = {
  elem: { color: "#23ccbe", behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1032, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.polonium_dioxide = {
  elem: { color: [blendColors("#ffff7f", "#ff0000"), blendColors("#ffff7f", "#00ff00"), blendColors("#ffff7f", "#0000ff")], behavior: behaviors.POWDER, category: "powders", density: 8900, state: "solid", hidden: true, },
  tempHigh: [500],
  categories: ["insoluble", "polonium_iv", "oxide"],
};

chemjsChemicals.magnesium_polonide = {
  elem: { color: [blendColors("#b5b5b5", "#ff0000", 0.25), blendColors("#b5b5b5", "#00ff00", 0.25), blendColors("#b5b5b5", "#0000ff", 0.25)], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 6700, hidden: true, },
  tempHigh: [1800],
...
chemjsChemicals.magnesium_polonide_solution = {
  elem: { color: [blendColors("#2167ff", "#ff0000", 0.25), blendColors("#2167ff", "#00ff00", 0.25), blendColors("#2167ff", "#0000ff", 0.25)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1050, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.francium_nihonide = {
  elem: { color: [blendColors("#d6d3a9", "#ff0000"), blendColors("#d6d3a9", "#00ff00"), blendColors("#d6d3a9", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 13700,/*made up*/  hidden: true, },
...
chemjsChemicals.radium_oxide = {
  elem: { color: [blendColors("#b2d9d9", "#ff0000", 0.25), blendColors("#b2d9d9", "#00ff00", 0.25), blendColors("#b2d9d9", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", density: 12000, state: "solid", hidden: true, },
  tempHigh: [1700],
  categories: ["insoluble", "radium_ion", "oxide"],
};
chemjsChemicals.radium_hydroxide = {
  elem: { color: [blendColors("#f2fafa", "#ff0000", 0.25), blendColors("#f2fafa", "#00ff00", 0.25), blendColors("#f2fafa", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", density: 12000, state: "solid", hidden: true, },
  tempHigh: [600],
...
chemjsChemicals.radium_chloride = {
  elem: { color: [blendColors("#faf3de", "#ff0000", 0.25), blendColors("#faf3de", "#00ff00", 0.25), blendColors("#faf3de", "#0000ff", 0.25)], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 4900, hidden: true, },
  tempHigh: [900],
...
chemjsChemicals.radium_chloride_solution = {
  elem: { color: [blendColors("#8eadef", "#ff0000", 0.25), blendColors("#8eadef", "#00ff00", 0.25), blendColors("#8eadef", "#0000ff", 0.25)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1050, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.actinium_oxide = {
  elem: { color: [blendColors("#ebf5f5", "#ff0000", 0.25), blendColors("#ebf5f5", "#00ff00", 0.25), blendColors("#ebf5f5", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", density: 12000, state: "solid", hidden: true, },
  tempHigh: [2327],
  categories: ["insoluble", "actinium_ion", "oxide"],
};
chemjsChemicals.actinium_hydroxide = {
  elem: { color: [blendColors("#f2cef2", "#ff0000", 0.25), blendColors("#f2cef2", "#00ff00", 0.25), blendColors("#f2cef2", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", density: 12000, state: "solid", hidden: true, },
  tempHigh: [600],
...
chemjsChemicals.unstable_thorium_dioxide = {
  elem: { color: ["#313331", "#1a1a18", "#171717", "#24231d", "#262622", "#171613"], behavior: ["XX|CR:radiation%0.01|XX", "CR:radiation%0.01|XX|CR:radiation%0.01", "M2|M1|M2"], category: "powders", state: "solid", density: 10000, },
  tempHigh: [2865],
...
elements.molten_thorium_dioxide = { behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.01|XX", "M2 AND CR:radiation%0.01|XX|M2 AND CR:radiation%0.01", "M1|M1|M1"], };


chemjsChemicals.stable_thorium_dioxide = {
  elem: { color: [blendColors("#313331", "#ff0000"), blendColors("#1a1a18", "#00ff00"), blendColors("#171717", "#0000ff"), blendColors("#24231d", "#ff0000"), blendColors("#262622", "#00ff00"), blendColors("#171613", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 10000, hidden: true, },
  tempHigh: [2865],
...
chemjsChemicals.unstable_thorium_tetrafluoride = {
  elem: { color: "#e5e6e5", behavior: ["XX|CR:radiation%0.01|XX", "CR:radiation%0.01|XX|CR:radiation%0.01", "M2|M1|M2"], category: "powders", state: "solid", density: 6300, hidden: true, },
  tempHigh: [1110],
...
elements.molten_thorium_tetrafluoride = { behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.01|XX", "M2 AND CR:radiation%0.01|XX|M2 AND CR:radiation%0.01", "M1|M1|M1"], };


chemjsChemicals.stable_thorium_tetrafluoride = {
  elem: { color: [blendColors("#e5e6e5", "#ff0000"), blendColors("#e5e6e5", "#00ff00"), blendColors("#e5e6e5", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 6300, hidden: true, },
  tempHigh: [1110],
...
chemjsChemicals.protactinium_v_oxide = {
  elem: { color: [blendColors("#353b3b", "#ff0000", 0.25), blendColors("#353b3b", "#00ff00", 0.25), blendColors("#353b3b", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", density: 12000, state: "solid", hidden: true, },
  tempHigh: [2500],
  categories: ["insoluble", "protactinium_v", "oxide"],
};
chemjsChemicals.protactinium_hydroxide = {
  elem: { color: [blendColors("#95c7c7", "#ff0000", 0.25), blendColors("#95c7c7", "#00ff00", 0.25), blendColors("#95c7c7", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", density: 12000, state: "solid", hidden: true, },
  tempHigh: [350],
...
chemjsChemicals.protactinium_v_fluoride = {
  elem: { color: [blendColors("#cbf2ec", "#ff0000", 0.25), blendColors("#cbf2ec", "#00ff00", 0.25), blendColors("#cbf2ec", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", density: 9000, state: "solid", hidden: true, },
  tempHigh: [2600],
...
chemjsChemicals.uraninite = {
  elem: { color: ["#545323", "#50573b", "#656660", "#4d4933", "#615e4a", "#525043"], behavior: ["XX|CR:radiation%0.05|XX", "CR:radiation%0.05|XX|CR:radiation%0.05", "M2|M1|M2"], category: "land", state: "solid", density: 10970, },
  tempHigh: [2865],
};

chemjsChemicals.yellowcake = {
  elem: { color: ["#545323", "#50573b", "#656660", "#4d4933", "#615e4a", "#525043"], behavior: ["XX|CR:radiation%0.05|XX", "CR:radiation%0.05|XX|CR:radiation%0.05", "M2|M1|M2"], category: "powders", hidden: true, state: "solid", density: 8300, },
  tempHigh: [1150],
};

chemjsChemicals.yellowcake_solution = {
  elem: { color: ["#d2ed6f"], behavior: ["XX|DB%5|XX", "DB%5 AND M2|XX|DB%5 AND M2", "DB%5 AND M2|DB%10 AND M1|DB%5 AND M2"], category: "liquids", state: "liquid", density: 1850, viscosity: 26.7, hidden: true, },
  tempHigh: [337],
...
chemjsChemicals.mixed_uranium_dioxide = {
  elem: { color: ["#474744", "#21211f", "#2b2b2b", "#9c998c", "#40403f", "#24231d"], behavior: ["XX|CR:radiation%0.05|XX", "CR:radiation%0.05|XX|CR:radiation%0.05", "M2|M1|M2"], category: "powders", state: "solid", density: 10970, },
  tempHigh: [2865],
...
elements.molten_uranium_dioxide = { behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.05|XX", "M2 AND CR:radiation%0.05|XX|M2 AND CR:radiation%0.05", "M1|M1|M1"], };


chemjsChemicals.uranium_238_dioxide = {
  elem: { color: ["#474744", "#21211f", "#2b2b2b", "#9c998c", "#40403f", "#24231d"], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 10970, hidden: true, },
  tempHigh: [2865],
...
chemjsChemicals.uranium_235_dioxide = {
  elem: { color: ["#474744", "#21211f", "#2b2b2b", "#9c998c", "#40403f", "#24231d"], behavior: ["XX|CR:radiation%0.25|XX", "CR:radiation%0.25|XX|CR:radiation%0.25", "M2|M1|M2"], category: "powders", state: "solid", density: 10970, excludeRandom: true, hidden: true,},
  tempHigh: [2865],
...
elements.molten_enriched_uranium_dioxide = { excludeRandom: true, behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.25|XX", "M2 AND CR:radiation%0.25|XX|M2 AND CR:radiation%0.25", "M1|M1|M1"], };

chemjsChemicals.stable_uranium_dioxide = {
  elem: { color: [blendColors("#474744", "#ff0000"), blendColors("#21211f", "#00ff00"), blendColors("#2b2b2b", "#0000ff"), blendColors("#9c998c", "#ff0000"), blendColors("#40403f", "#00ff00"), blendColors("#24231d", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 10970, hidden: true, },
  tempHigh: [2865],
...
chemjsChemicals.mixed_uranium_tetrafluoride = {
  elem: { color: ["#495747", "#394d38", "#5a7859"], behavior: ["XX|CR:radiation%0.05|XX", "CR:radiation%0.05|XX|CR:radiation%0.05", "M2|M1|M2"], category: "powders", state: "solid", density: 6700, hidden: true, },
  tempHigh: [1036],
...
elements.molten_uranium_tetrafluoride = { behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.05|XX", "M2 AND CR:radiation%0.05|XX|M2 AND CR:radiation%0.05", "M1|M1|M1"], };


chemjsChemicals.uranium_238_tetrafluoride = {
  elem: { color: ["#495747", "#394d38", "#5a7859"], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 6700, hidden: true, },
  tempHigh: [1036],
...
chemjsChemicals.uranium_235_tetrafluoride = {
  elem: { color: ["#495747", "#394d38", "#5a7859"], behavior: ["XX|CR:radiation%0.25|XX", "CR:radiation%0.25|XX|CR:radiation%0.25", "M2|M1|M2"], category: "powders", state: "solid", density: 6700, hidden: true, },
  tempHigh: [1036],
...
elements.molten_enriched_uranium_tetrafluoride = { behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.25|XX", "M2 AND CR:radiation%0.25|XX|M2 AND CR:radiation%0.25", "M1|M1|M1"], };

chemjsChemicals.stable_uranium_tetrafluoride = {
  elem: { color: [blendColors("#495747", "#ff0000"), blendColors("#394d38", "#00ff00"), blendColors("#5a7859", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 6700, hidden: true, },
  tempHigh: [1036],
...
chemjsChemicals.mixed_uranium_hexafluoride = {
  elem: { color: "#f7fff7", behavior: ["XX|CR:radiation%0.05|XX", "CR:radiation%0.05|XX|CR:radiation%0.05", "M2|M1|M2"], category: "powders", state: "solid", density: 5090, hidden: true, },
  tempHigh: [56.5],
...
elements.uranium_hexafluoride_gas = { behavior: behaviors.GAS, behavior2: [["XX", "CR:radiation%0.05", "XX"], ["CR:radiation%0.05", "XX", "CR:radiation%0.05"], ["XX", "CR:radiation%0.05", "XX"],], tick: gasTick, state: "gas", density: 12.84, onCentrifuge: uraniumHexafluorideCentrifuge };

chemjsChemicals.uranium_238_hexafluoride = {
  elem: { color: "#f7fff7", behavior: behaviors.POWDER, category: "powders", state: "solid", density: 5090, hidden: true, },
  tempHigh: [56.5],
...
elements.depleted_uranium_hexafluoride_gas = { behavior: behaviors.GAS, state: "gas", density: 12.84 };


chemjsChemicals.uranium_235_hexafluoride = {
  elem: { color: "#f7fff7", behavior: ["XX|CR:radiation%0.25|XX", "CR:radiation%0.25|XX|CR:radiation%0.25", "M2|M1|M2"], category: "powders", state: "solid", density: 5090, hidden: true, },
  tempHigh: [56.5],
...
elements.enriched_uranium_hexafluoride_gas = { behavior: behaviors.GAS, behavior2: [["XX", "CR:radiation%0.25", "XX"], ["CR:radiation%0.25", "XX", "CR:radiation%0.25"], ["XX", "CR:radiation%0.25", "XX"],], tick: gasTick, state: "gas", density: 12.84 };

chemjsChemicals.stable_uranium_hexafluoride = {
  elem: { color: [blendColors("#f7fff7", "#ff0000"), blendColors("#f7fff7", "#00ff00"), blendColors("#f7fff7", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 5090, hidden: true, },
  tempHigh: [56.5],
...
elements.stable_uranium_hexafluoride_gas = { behavior: behaviors.GAS, state: "gas", density: 12.84 };




chemjsChemicals.neptunium_dioxide = {
  elem: { color: [blendColors("#47c94f", "#ff0000"), blendColors("#47c94f", "#00ff00"), blendColors("#47c94f", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 12000, hidden: true, },
  tempHigh: [2600],
...
chemjsChemicals.neptunium_tetrafluoride = {
  elem: { color: [blendColors("#73e67a", "#ff0000"), blendColors("#73e67a", "#00ff00"), blendColors("#73e67a", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 12000, hidden: true, },
  tempHigh: [2550],
...
chemjsChemicals.neptunium_hexafluoride = {
  elem: { color: [blendColors("#eda042", "#ff0000"), blendColors("#eda042", "#00ff00"), blendColors("#eda042", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 5000, hidden: true, },
  tempHigh: [55],
...
elements.neptunium_hexafluoride_gas = { behavior: behaviors.GAS, state: "gas", density: 14.591, };
...
chemjsChemicals.mixed_plutonium_dioxide = {
  elem: {  color: ["#edcf47", "#c7a924", "#e3c129"], behavior: ["XX|CR:radiation%0.25|XX", "CR:radiation%0.25|XX|CR:radiation%0.25", "M2|M1|M2"],category: "powders", state: "solid", density: 11500, excludeRandom: true, hidden: true,},
  tempHigh: [2744],
...
elements.molten_plutonium_dioxide = { excludeRandom: true, behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.05|XX", "M2 AND CR:radiation%0.05|XX|M2 AND CR:radiation%0.05", "M1|M1|M1"], };


chemjsChemicals.plutonium_242_dioxide = {
  elem: { color: ["#edcf47", "#c7a924", "#e3c129"], behavior: ["XX|CR:radiation%0.1|XX", "CR:radiation%0.1|XX|CR:radiation%0.1", "M2|M1|M2"], category: "powders", state: "solid", density: 11500, hidden: true, },
  tempHigh: [2744],
...
elements.molten_depleted_plutonium_dioxide = { excludeRandom: true, behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.1|XX", "M2 AND CR:radiation%0.1|XX|M2 AND CR:radiation%0.1", "M1|M1|M1"], };



chemjsChemicals.plutonium_239_dioxide = {
  elem: {
    color: ["#edcf47", "#c7a924", "#e3c129"], behavior: ["XX|CR:radiation%0.5|XX", "CR:radiation%0.5|XX|CR:radiation%0.5", "M2|M1|M2"], category: "powders", state: "solid", density: 11500, excludeRandom: true, hidden: true,
  },
  tempHigh: [2744],
...
elements.molten_enriched_plutonium_dioxide = { excludeRandom: true, behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.5|XX", "M2 AND CR:radiation%0.5|XX|M2 AND CR:radiation%0.5", "M1|M1|M1"], };

chemjsChemicals.stable_plutonium_dioxide = {
  elem: { color: [blendColors("#edcf47", "#ff0000"), blendColors("#c7a924", "#00ff00"), blendColors("#e3c129", "#0000ff"), blendColors("#9c998c", "#ff0000")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 11500, hidden: true, },
  tempHigh: [2744],
...
chemjsChemicals.mixed_plutonium_tetrafluoride = {
  elem: { color: ["#a13d0b", "#85401d", "#733211"], behavior: [["XX|CR:radiation%0.05|XX", "CR:radiation%0.05|XX|CR:radiation%0.05", "M2|M1|M2"]], category: "powders", state: "solid", density: 6700, hidden: true, },
  tempHigh: [1027],
...
elements.molten_plutonium_tetrafluoride = { behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.05|XX", "M2 AND CR:radiation%0.05|XX|M2 AND CR:radiation%0.05", "M1|M1|M1"], };


chemjsChemicals.plutonium_242_tetrafluoride = {
  elem: { color: ["#a13d0b", "#85401d", "#733211"], behavior: ["XX|CR:radiation%0.02|XX", "CR:radiation%0.02|XX|CR:radiation%0.02", "M2|M1|M2"], category: "powders", state: "solid", density: 6700, hidden: true, },
  tempHigh: [1027],
...
elements.molten_depleted_plutonium_tetrafluoride = { behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.02|XX", "M2 AND CR:radiation%0.02|XX|M2 AND CR:radiation%0.02", "M1|M1|M1"], };



chemjsChemicals.plutonium_239_tetrafluoride = {
  elem: { color: ["#a13d0b", "#85401d", "#733211"], behavior: ["XX|CR:radiation%0.02|XX", "CR:radiation%0.25|XX|CR:radiation%0.25", "M2|M1|M2"], category: "powders", state: "solid", density: 6700, hidden: true, },
  tempHigh: [1027],
...
elements.molten_enriched_plutonium_tetrafluoride = { behavior: ["XX|CR:fire%2.5 AND CR:radiation%0.1|XX", "M2 AND CR:radiation%0.1|XX|M2 AND CR:radiation%0.1", "M1|M1|M1"], };

chemjsChemicals.stable_plutonium_tetrafluoride = {
  elem: { color: [blendColors("#a13d0b", "#ff0000"), blendColors("#85401d", "#00ff00"), blendColors("#733211", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 6700, hidden: true, },
  tempHigh: [1027],
...
chemjsChemicals.mixed_plutonium_hexafluoride = {
  elem: { color: "#6e2602", behavior: ["XX|CR:radiation%0.05|XX", "CR:radiation%0.05|XX|CR:radiation%0.05", "M2|M1|M2"], category: "powders", state: "solid", density: 5080, hidden: true, },
  tempHigh: [62.5,280],
...
chemjsChemicals.plutonium_242_hexafluoride = {
  elem: { color: "#6e2602", behavior: ["XX|CR:radiation%0.01|XX", "CR:radiation%0.01|XX|CR:radiation%0.01", "M2|M1|M2"], category: "powders", state: "solid", density: 5080, hidden: true, },
  tempHigh: [62.5,280],
...
elements.depleted_plutonium_hexafluoride_gas = { behavior: behaviors.GAS, behavior2: [["XX", "CR:radiation%0.01", "XX"], ["CR:radiation%0.01", "XX", "CR:radiation%0.01"], ["XX", "CR:radiation%0.01", "XX"],], tick: gasTick, state: "gas", density: 14.88 };


chemjsChemicals.plutonium_239_hexafluoride = {
  elem: { color: "#6e2602", behavior: ["XX|CR:radiation%0.25|XX", "CR:radiation%0.25|XX|CR:radiation%0.25", "M2|M1|M2"], category: "powders", state: "solid", density: 5080, hidden: true, },
  tempHigh: [62.5,280],
...
elements.enriched_plutonium_hexafluoride_gas = { behavior: behaviors.GAS, behavior2: [["XX", "CR:radiation%0.25", "XX"], ["CR:radiation%0.25", "XX", "CR:radiation%0.25"], ["XX", "CR:radiation%0.25", "XX"],], tick: gasTick, state: "gas", density: 14.88 };

chemjsChemicals.stable_plutonium_hexafluoride = {
  elem: { color: [blendColors("#6e2602", "#ff0000"), blendColors("#6e2602", "#00ff00"), blendColors("#6e2602", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 5080, hidden: true, },
  tempHigh: [62.5,280],
...
elements.stable_plutonium_hexafluoride_gas = { behavior: behaviors.GAS, state: "gas", density: 14.88 };



chemjsChemicals.copernicium_dioxide = {
  elem: { color: [blendColors("#e6c973", "#ff0000", 0.25), blendColors("#e6c973", "#00ff00", 0.25), blendColors("#e6c973", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 13120,/*made up*/  hidden: true, },
...
chemjsChemicals.copernicium_tetrafluoride = {
  elem: { color: [blendColors("#eff2e4", "#ff0000", 0.25), blendColors("#eff2e4", "#00ff00", 0.25), blendColors("#eff2e4", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 12110,/*made up*/ hidden: true, },
...
chemjsChemicals.copernicium_sulfide = {
  elem: { color: [blendColors("#9c5f4f", "#ff0000", 0.25), blendColors("#9c5f4f", "#00ff00", 0.25), blendColors("#9c5f4f", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 13200,/*made up*/ hidden: true, },
...
chemjsChemicals.nihonium_oxide = {
  elem: { color: [blendColors("#ab9a95", "#ff0000", 0.25), blendColors("#ab9a95", "#00ff00", 0.25), blendColors("#ab9a95", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 12370,/*made up*/  hidden: true, },
...
chemjsChemicals.nihonium_hydroxide = {
  elem: { color: [blendColors("#ebc7c7", "#ff0000", 0.25), blendColors("#ebc7c7", "#00ff00", 0.25), blendColors("#ebc7c7", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 10220,/*made up*/  hidden: true, },
...
chemjsChemicals.nihonium_nitrate = {
  elem: { color: [blendColors("#fccadd", "#ff0000", 0.25), blendColors("#fccadd", "#00ff00", 0.25), blendColors("#fccadd", "#0000ff", 0.25)],  behavior: behaviors.POWDER, state: "solid", category: "powders", density: 9350,  hidden: true, },
  tempHigh: [203],
...
chemjsChemicals.nihonium_nitrate_solution = {
  elem: { color: [blendColors("#8f19f7", "#ff0000", 0.25), blendColors("#8f19f7", "#00ff00", 0.25), blendColors("#8f19f7", "#0000ff", 0.25)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1090, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.nihonium_sulfate = {
  elem: { color:  [blendColors("#fcf1ca", "#ff0000", 0.25), blendColors("#fcf1ca", "#00ff00", 0.25), blendColors("#fcf1ca", "#0000ff", 0.25)],  behavior: behaviors.POWDER, state: "solid", category: "powders", density: 12050,  hidden: true, },
  tempHigh: [1305],
...
chemjsChemicals.nihonium_sulfate_solution = {
  elem: { color: [blendColors("#1984f7", "#ff0000", 0.25), blendColors("#1984f7", "#00ff00", 0.25), blendColors("#1984f7", "#0000ff", 0.25)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1092, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.flerovium_sulfide = {
  elem: { color: [blendColors("#121107", "#ff0000", 0.25), blendColors("#121107", "#00ff00", 0.25), blendColors("#121107", "#0000ff", 0.25)], behavior: behaviors.WALL, category: "solids", state: "solid", density: 14700,/*made up*/ hidden: true, burnInto: ["flerovium_oxide", "sulfur_dioxide"],burn: 1,},
...
chemjsChemicals.flerovium_oxide = {
  elem: { color: [ blendColors("#d9d8d4", "#ff0000", 0.25), blendColors("#d9d8d4", "#00ff00", 0.25), blendColors("#d9d8d4", "#0000ff", 0.25)], behavior: behaviors.STURDYPOWDER, category: "powders", state: "solid", density: 14320,/*made up*/ hidden: true,},
...
chemjsChemicals.moscovium_hydroxide = {
  elem: { color:  [blendColors("#fcf1ca", "#ff0000", 0.25), blendColors("#fcf1ca", "#00ff00", 0.25), blendColors("#fcf1ca", "#0000ff", 0.25)],  behavior: behaviors.POWDER, state: "solid", category: "powders", density: 5620,  hidden: true, },
  tempHigh: [670],
...
chemjsChemicals.moscovium_hydroxide_solution = {
  elem: { color: [blendColors("#6548f7", "#ff0000", 0.25), blendColors("#6548f7", "#00ff00", 0.25), blendColors("#6548f7", "#0000ff", 0.25)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1092, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.moscovium_fluoride = {
  elem: { color: [blendColors("#eedff5", "#ff0000", 0.25), blendColors("#eedff5", "#00ff00", 0.25), blendColors("#eedff5", "#0000ff", 0.25)], behavior: behaviors.STURDYPOWDER, category: "powders", state: "solid", density: 6220,/*made up*/ hidden: true,},
...
chemjsChemicals.livermorium_oxide = {
  elem: { color: [blendColors("#ebcb8f", "#ff0000", 0.25), blendColors("#ebcb8f", "#00ff00", 0.25), blendColors("#ebcb8f", "#0000ff", 0.25)], behavior: behaviors.STURDYPOWDER, category: "powders", state: "solid", density: 12430,/*made up*/ hidden: true,},
...
chemjsChemicals.ununennium_fluoride = {
  elem: { color: [blendColors("#e1e4eb", "#ff0000", 0.25), blendColors("#e1e4eb", "#00ff00", 0.25), blendColors("#e1e4eb", "#0000ff", 0.25)], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 6703, hidden: true, },
...
chemjsChemicals.ununennium_fluoride_solution = {
  elem: { color:  [blendColors("#3061f2", "#ff0000", 0.25), blendColors("#3061f2", "#00ff00", 0.25), blendColors("#3061f2", "#0000ff", 0.25)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1094, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.ununennium_trifluoride = {
  elem: { color: [blendColors("#ccb87a", "#ff0000", 0.25), blendColors("#ccb87a", "#00ff00", 0.25), blendColors("#ccb87a", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 7200,/*made up*/ hidden: true,},
...
chemjsChemicals.ununennium_pentafluoride = {
  elem: { color: [blendColors("#db5030", "#ff0000", 0.25), blendColors("#db5030", "#00ff00", 0.25), blendColors("#db5030", "#0000ff", 0.25)], behavior: behaviors.CAUSTIC, category: "powders", state: "solid", density: 7250,/*made up*/ hidden: true, },
  tempHigh: [70], //made up
...
chemjsChemicals.unbinilium_oxide = {
  elem: { color: [blendColors("#f5f2e1", "#ff0000", 0.25), blendColors("#f5f2e1", "#00ff00", 0.25), blendColors("#f5f2e1", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", density: 15000, state: "solid", hidden: true, },
  tempHigh: [2763],
  categories: ["insoluble", "unbinilium_ii", "oxide"],
};
chemjsChemicals.unbinilium_hydroxide = {
  elem: { color: [blendColors("#f9faf2", "#ff0000", 0.25), blendColors("#f9faf2", "#00ff00", 0.25), blendColors("#f9faf2", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", density: 12000, state: "solid", hidden: true, },
  tempHigh: [620],
...
chemjsChemicals.unbinilium_difluoride = {
  elem: { color: [blendColors("#e8ebe1", "#ff0000", 0.25), blendColors("#e8ebe1", "#00ff00", 0.25), blendColors("#e8ebe1", "#0000ff", 0.25)], behavior: behaviors.POWDER, state: "solid", category: "powders", density: 6800, hidden: true, },
...
chemjsChemicals.unbinilium_difluoride_solution = {
  elem: { color: [blendColors("#3087f2", "#ff0000", 0.25), blendColors("#3087f2", "#00ff00", 0.25), blendColors("#3087f2", "#0000ff", 0.25)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1095, hidden: true, conduct: 0.1, stain: -0.66, },
  tempLow: [-2],
  tempHigh: [102],
...
chemjsChemicals.unbinilium_tetrafluoride = {
  elem: { color: [blendColors("#e0dd12", "#ff0000", 0.25), blendColors("#e0dd12", "#00ff00", 0.25), blendColors("#e0dd12", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 7500,/*made up*/ hidden: true,},
...
chemjsChemicals.unbinilium_hexafluoride = {
  elem: { color: [blendColors("#ffca7a", "#ff0000", 0.25), blendColors("#ffca7a", "#00ff00", 0.25), blendColors("#ffca7a", "#0000ff", 0.25)], behavior: behaviors.CAUSTIC, category: "powders", state: "solid", density: 7700,/*made up*/ hidden: true, },
  tempHigh: [70], //made up
...
chemjsChemicals.diborane = {
  elem: { color: "#ffcac9", behavior: behaviors.GAS, state: "gas", category: "gases", density: 1.131, burn: 100, burnTime: 20, burnInto: "boron_trioxide",fireColor: ["#34eb67", "#5ceb34"],},
  tempLow: [-92.5, -164],
  tempHigh: [200],
...
chemjsChemicals.pentaborane_9 = {
  elem: { name: "pentaborane(9)", color: "#f7b5b5", behavior: behaviors.LIQUID, state: "liquid", category: "liquids", density: 618, hidden: true, burn: 100, burnTime: 5, burnInto: "explosion", fireColor: ["#34eb67", "#5ceb34"], },
  tempLow: [-46.8],
  tempHigh: [60.1, 250],
...
chemjsChemicals.decaborane = {
  elem: { color: "#d9cece", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 940, hidden: true, burn: 100, burnTime: 100, burnInto: "boron_trioxide",fireColor: ["#34eb67", "#5ceb34"],},
  tempHigh: [98],
  toxic: [0.1],
};
...
chemjsChemicals.trimethyl_borate = {
  elem: { color: "#c4bc89", behavior: behaviors.LIQUID, state: "liquid", category: "liquids", density: 932, burn: 100,fireColor: ["#34eb67", "#5ceb34"],burnTime: 10,hidden: true },
  tempLow: [-34],
  tempHigh: [69],
  toxic: [0.2],
  densityHigh: [4.32],
...
chemjsChemicals.boron_trifluoride = {
  elem: { color: "#d5d9ce", behavior: behaviors.GAS, state: "gas", category: "gases", density: 2.76, hidden: true },
  tempLow: [-100.3, -126.8],
  toxic: [0.1],
  densityLow: [1640],
  causticIgnore: true,
...
chemjsChemicals.boron_trichloride = {
  elem: { color: "#ddf0dd", behavior: behaviors.GAS, state: "gas", category: "gases", density: 4.87, hidden: true },
  tempLow: [-12.6, -107.3],
  toxic: [0.2],
  densityLow: [1326],
  causticIgnore: true,
...
chemjsChemicals.nitric_oxide = {
  elem: { color: "#b8926c", behavior: behaviors.GAS, state: "gas", category: "gases", density: 1.34 },
  tempLow: [-152, -164],
  toxic: [0.1],
  densityLow: [1280],
  causticIgnore: true,
...
chemjsChemicals.nitrogen_dioxide = {
  elem: { color: "#964B00", behavior: behaviors.GAS, temp: 30, category: "gases", state: "gas", density: 3.4 },
  tempLow: [21.15, -9.3],
  toxic: [0.2],
  densityLow: [1447],
  causticIgnore: true,
...
chemjsChemicals.foof = {
  elem: { color: "#fa1e1e", behavior: behaviors.LIQUID, tick: (pixel) => foofTick(pixel, 0.0001), state: "liquid", category: "liquids", density: 1450, stain: 0.01, temp: -120, },
  tempHigh: [-57],
...
elements.solid_foof = { color: "#fa4a1e", behavior: behaviors.WALL, tick: (pixel) => foofTick(pixel, 0.00005), state: "solid", category: "solids", hidden: true };
...
chemjsChemicals.phosphorus_pentoxide = {
  elem: { color: "#fcfcfa", behavior: behaviors.POWDER, state: "solid", category: "powders", density: 2390,fireColor: "#5ed6c8",},
  tempHigh: [340],
};

chemjsChemicals.hydrogen_sulfide = {
  elem: { color: "#d9e366", behavior: behaviors.GAS, category: "gases", state: "gas", density: 1.539, burn: 1, burnTime: 10, burnInto: ["sulfur_dioxide", "steam"], fireColor: ["#8180CC", "#7F84E6"], },
  tempLow: [-59.55, -85.5],
  tempHigh: [1000],
  stateHigh: [["fire"]],
  densityLow: [992],
...
chemjsChemicals.sulfur_dioxide = {
  elem: { color: "#FFF700", behavior: behaviors.GAS, category: "gases", state: "gas", density: 2.6 },
  tempLow: [-10, -72],
  densityLow: [1435],
  toxic: [0.1],
  causticIgnore: true,
...
chemjsChemicals.sulfur_hexafluoride = {
  elem: { color: "#f2ff00", behavior: behaviors.GAS, category: "gases", state: "gas", density: 6.17 },
  tempLow: [-50.8, -64],
  densityLow: [1339],
  causticIgnore: true,
};
...
chemjsChemicals.titanium_tetrachloride = {
  elem: { color: "#d9d7b2", behavior: behaviors.LIQUID, category: "liquids", density: 1728, state: "liquid", viscosity: 0.827, },
  tempHigh: [136.4],
  densityHigh: [7.753],
  tempLow: [-24],
...
chemjsChemicals.tungsten_hexafluoride = {
  elem: { color: "#f5f57a", behavior: behaviors.GAS, category: "gases", state: "gas", density: 12.4, stain: 0.005 },
  tempLow: [17.1, -2.3],
  densityLow: [4560],
  causticIgnore: true,
};
...
chemjsChemicals.polonium_hydride = {
  elem: { color: [blendColors("#838396", "#ff0000"), blendColors("#838396", "#00ff00"), blendColors("#838396", "#0000ff")], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 2450, burn: 1, burnTime: 10, burnInto: ["polonium_dioxide", "steam"], hidden: true, stain: 0.05 },
  tempLow: [-35.3],
  tempHigh: [36.1],
  densityHigh: [8.29],
...
chemjsChemicals.methanol = {
  elem: { color: "#969380", behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 792, burn: 100, burnTime: 3, fireColor: ["#80acf0", "#96cdfe", "#bee6d4"], viscosity: 0.545, },
  tempLow: [-97.6],
  tempHigh: [64.7, 385],
  stateHigh: [null, ["fire"]],
  densityHigh: [1.332],
...
chemjsChemicals.ethane = {
  elem: { color: "#afafaf", behavior: behaviors.GAS, category: "gases", state: "gas", density: 1.356, burn: 85, burnTime: 5, fireColor: ["#00ffff", "#00ffdd"], },
  tempLow: [-88.5, -142],
  densityLow: [544],
  tempHigh: [400],
  stateHigh: [["fire"]],
...
chemjsChemicals.ethylene = {
  elem: { color: "#afafaf", behavior: behaviors.GAS, category: "gases", state: "gas", density: 1.178, burn: 100, burnTime: 5, fireColor: ["#00ffff", "#00ffdd"], },
  tempLow: [-103.7, -154.4],
  densityLow: [567],
  tempHigh: [400],
  stateHigh: [["fire"]],
...
chemjsChemicals.polyethylene = {
  elem: { color: "#a7a7a7", behavior: behaviors.WALL, properties: { colored: false, }, tick: plasticTick, category: "solids", state: "solid", density: 1450, },
  tempHigh: [125],
  causticIgnore: true,
};
...
chemjsChemicals.tetrafluoroethylene = {
  elem: { color: "#8f8f8f", behavior: behaviors.GAS, category: "gases", state: "gas", density: 4.16, burn: 100, burnTime: 2, hidden: true },
  tempLow: [-76, -142],
  densityLow: [1519],
  causticIgnore: true,
  toxic: [0.2],
...
chemjsChemicals.polytetrafluoroethylene = {
  elem: { color: "#efefef", behavior: behaviors.WALL, properties: { colored: false, }, tick: plasticTick, category: "solids", state: "solid", density: 1450, },
  tempHigh: [327],
  causticIgnore: true,
};

chemjsChemicals.chloroform = {
  elem: { color: "#7f7f7f", behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 1564, viscosity: 0.563, },
  tempLow: [-63],
  densityHigh: [1.489],
  tempHigh: [61],
  causticIgnore: true,
...
chemjsChemicals.chloroethane = {
  elem: { color: "#afdfaf", behavior: behaviors.GAS, category: "gases", state: "gas", density: 2.879, burn: 85, burnTime: 5, fireColor: ["#00ffff", "#00ffdd"], },
  tempLow: [12.27, -138.7],
  densityLow: [921],
  tempHigh: [510],
  stateHigh: [["fire"]],
...
chemjsChemicals.diethylaluminium_chloride = {
  elem: { color: "#7faf7f", behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 960, hidden: true, burn: 100, burnTime: 500, fireColor: ["#ffffff"], },
  tempLow: [-74],
  densityHigh: [2.879],
  tempHigh: [125, 175],
  stateHigh: [null, ["fire"]],
...
chemjsChemicals.radium_water = {
  elem: { color: "#3bc4ff", behavior: ["XX|CR:radiation%0.05|XX", "M2 AND CR:radiation%0.05|XX|M2 AND CR:radiation%0.05", "M1|M1|M1"], category: "liquids", state: "liquid", density: 1100, hidden: true,},
  tempLow: [0],
  densityHigh: [2.879],
  tempHigh: [100],
  stateHigh: [["rad_steam"]],
...
chemjsChemicals.tennessine_monofluoride = {
  elem: { color: [blendColors("#4a4123", "#ff0000", 0.25), blendColors("#4a4123", "#00ff00", 0.25), blendColors("#4a4123", "#0000ff", 0.25)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 5200, hidden: true, stain: 0.2, },
  tempLow: [5], //made up
  densityHigh: [13.012],
  tempHigh: [130],
  toxic: [0.1],
...
chemjsChemicals.tennessine_trifluoride = {
  elem: { color: [blendColors("#ffc400", "#ff0000", 0.25), blendColors("#ffc400", "#00ff00", 0.25), blendColors("#ffc400", "#0000ff", 0.25)], behavior: behaviors.LIQUID, category: "liquids", state: "liquid", density: 5600, hidden: true, stain: 0.3, },
  tempLow: [3], //made up
  densityHigh: [14.591],
  tempHigh: [105],
  toxic: [0.1],
...
chemjsChemicals.oganesson_difluoride = {
  elem: { color: [blendColors("#e3e2de", "#ff0000", 0.25), blendColors("#e3e2de", "#00ff00", 0.25), blendColors("#e3e2de", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 6100, hidden: true, },
  tempHigh: [160], //made up
  toxic: [0.1],
};

chemjsChemicals.oganesson_tetrafluoride = {
  elem: { color: [blendColors("#d6d5d2", "#ff0000", 0.25), blendColors("#d6d5d2", "#00ff00", 0.25), blendColors("#d6d5d2", "#0000ff", 0.25)], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 6300, hidden: true, },
  tempHigh: [120], //made up
  toxic: [0.1],
};

chemjsChemicals.oganesson_tetratennesside = {
  elem: { color: [blendColors("#f7f7f5", "#ff0000"), blendColors("#f7f7f5", "#00ff00"), blendColors("#f7f7f5", "#0000ff")], behavior: behaviors.POWDER, category: "powders", state: "solid", density: 13800, hidden: true, },
...
chemjsReactions = [
  ...
  {
    react1: "chemical!liquid_salt_water", react2: "greek_fire", elem1: "no_change", elem2: "no_change", props: {
