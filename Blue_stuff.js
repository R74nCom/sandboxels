...
hoverStat: function(pixel){return pixel.BlueAge},
    reactions: {"FlyingBlue": {elem2: "PregFlyingBlue", chance:0.0018},},
}
var BlueAge = 0;
elements.PregFlyingBlue = { 
    ...
    state: "Solid",
    behavior: [
        "M1 AND CR:ThisIsOneNiceEgg%0.25|M1 AND CR:ThisIsOneNiceEgg%0.25|M1 AND CR:ThisIsOneNiceEgg%0.25",
        "M1 AND CR:ThisIsOneNiceEgg%0.25|CH:FlyingBlue%0.01 AND Ch:EvilPregnantBlue%0.0002|M1 AND CR:ThisIsOneNiceEgg%0.25",
        "M1 AND CR:ThisIsOneNiceEgg%0.25|M1 AND CR:ThisIsOneNiceEgg%0.25|M1 AND CR:ThisIsOneNiceEgg%0.25",
        ],
    conduct : 0,
    movable: true,
...
elements.ThisIsOneNiceEgg = { 
    ...
    behavior:[
    "XX|M1%8|XX",
    "XX|CH:ThisIsOneNiceEgg>DeadBlue%0.001 AND CH:NewbornBlue%1.5 AND CH:EvilNewbornBlue%0.0009 AND CH:PureBloodedBlue%0.0000000019|XX",
    "XX|M1%20|XX",
    ],
    conduct : 0,
    movable: true,
...
elements.NewbornBlue = { 
    ...
    behavior:[
    "M1|M1|M1",
    "M1|CH:NewbornBlue>FlyingBlue%1|M1",
    "M1|M1|M1",
    ],
    conduct : 0,
    movable: true,
...
elements.EvilFlyingBlue = { 
    ...
    reactions: {
    "FlyingBlue": {elem2: "EvilFlyingBlue", chance:0.4 },
    "FlyingBlue": {elem2: "DeadBlue", chance:0.2 },
    "NewbornBlue": {elem2: "EvilNewbornBlue", chance:0.8 },
    "NewborngBlue": {elem2: "DeadBlue", chance:0.1 },
    "BlueHot": {elem2: "EvilBlueHot" },
    "FrozenBlue": {elem2: "EvilFrozenBlue" },
    "ThisIsOneNiceEgg": {elem2: "ThisIsNotSuchaNiceEgg" },
    "EvilFlyingBlue": {elem2: "EvilPregFlyingBlue", chance:0.0015},
    },
}
var EvilBlueAge = 0;
elements.EvilPregFlyingBlue = { 
    ...
    state: "Solid",
    behavior: [
        "M1 AND CR:ThisIsNotSuchaNiceEgg%0.2|M1 AND CR:ThisIsNotSuchaNiceEgg%0.2|M1 AND CR:ThisIsNotSuchaNiceEgg%0.2",
        "M1 AND CR:ThisIsNotSuchaNiceEgg%0.2|CH:EvilFlyingBlue%0.01|M1 AND CR:ThisIsNotSuchaNiceEgg%0.2",
        "M1 AND CR:ThisIsNotSuchaNiceEgg%0.2|M1|M1 AND CR:ThisIsNotSuchaNiceEgg%0.2",
        ],
    conduct : 0,
    movable: true,
    temp: 0,
    ...
    hoverStat: function(pixel){return pixel.EvilBlueAge},
    reactions: {
    "FlyingBlue": {elem2: "EvilFlyingBlue", chance:0.3 },
    "FlyingBlue": {elem2: "DeadBlue", chance:0.15 },
    "NewbornBlue": {elem2: "EvilNewbornBlue", chance:0.95 },
    "BlueHot": {elem2: "EvilBlueHot" },
    "FrozenBlue": {elem2: "EvilFrozenBlue" },
    "ThisIsOneNiceEgg": {elem2: "ThisIsNotSuchaNiceEgg" },
    ...
    elements.ThisIsNotSuchaNiceEgg = { 
        ...
        state: "solid",
        behavior:[
        "CR:EvilNewbornBlue%0.1|M1%4 AND CR:EvilNewbornBlue%0.1|CR:EvilNewbornBlue%0.1",
        "CR:EvilNewbornBlue%0.1|CH:EvilNewbornBlue%0.7 AND CH:NewbornBlue%0.004 AND EX:14>EvilNewbornBlue%0.0001|CR:EvilNewbornBlue%0.1",
        "CR:EvilNewbornBlue%0.1|M1%10 AND CR:EvilNewbornBlue%0.1|CR:EvilNewbornBlue%0.1",
        ],
        conduct : 0,
        movable: true,
        temp: 0,
...
elements.EvilNewbornBlue = { 
    ...
    hidden: 1,
    tick: function(pixel){
        if (pixel.start === pixelTicks)        //to set each pixels variable to the answer'd variable
        {pixel.PingPong = 0}
        pixel.PingPong ++
    },
    reactions: {
